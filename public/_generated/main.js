(function () {
	...
	const file$1 = "src/components/AtlasTooltip.html";
	...
	const file$3 = "src/library/Loading.html";
	...
	const file$5 = "src/library/Placeholder.html";
	...
	const file$7 = "src/library/NotebookLink.html";
	...
	const file$8 = "src/library/Button.html";
	...
	const file$9 = "src/library/icons/svg/baseline-add-24px.svg";
	...
	const file$a = "src/library/icons/svg/baseline-remove-24px.svg";
	...
	const file$b = "src/library/icons/svg/baseline-home-24px.svg";
	...
	const file$c = "src/library/icons/Navigation.html";
	...
	const file$g = "src/components/AppLayerChooser.html";
	...
	const file$h = "src/components/AppClassFilter.html";
	...
	const file$j = "src/library/D3Zoom.html";
	...
	function create_main_fragment$o(component, ctx) {
		var div26, div1, h20, text1, div0, appclassfilter_updating = {}, text2, div3, h21, text4, div2, applayerchooser_updating = {}, text5, div25, div24, atlas_updating = {}, text6, div23, div7, div5, div4, appminimap_updating = {}, text7, div6, text8, text9, text10, div21, div8, label0, input0, text11, text12, label1, input1, text13, text14, label2, input2, text15, text16, div20, div19, div11, h30, text18, label3, input3, text19, text20, label4, input4, text21, text22, label5, input5, text23, text24, label6, input6, text25, text26, label7, input7, text27, text28, label8, input8, text29, text30, div10, div9, text31, raw0_before, text32, input9, text33, div12, h31, text34, raw1_before, text35, input10, text36, div14, h32, text38, label9, input11, text39, text40, label10, input12, text41, text42, div13, text43, raw2_before, text44, input13, text45, div18, h33, text47, div15, text48, text49_value = format_1$1(ctx.gcx), text49, text50, div16, text51, text52_value = format_1$1(ctx.gcy), text52, text53, div17, text54, text55_value = format_1$1(ctx.scale), text55, text56, div22, button3, text57_value = ctx.showOptions ? 'fewer options' : 'more options', text57, div23_class_value;
		...
		return {
			c: function create() {
				...
				text34 = createText("Icon density: ");
				...
				text39 = createText(" positive influence");
				text40 = createText("\n                  ");
				label10 = createElement("label");
				input12 = createElement("input");
				text41 = createText(" negative influence");
				text42 = createText("\n                  ");
				div13 = createElement("div");
				text43 = createText("Intensity: ");
				...
				text51 = createText("y: ");
				text52 = createText(text52_value);
				text53 = createText("\n                  ");
				div17 = createElement("div");
				text54 = createText("scale: ");
				...
				input9.max = 1.4;
				input9.step = 0.01;
				addLoc(input9, file$n, 89, 20, 3627);
				setStyle(div10, "display", (ctx.gridSize == -1 ? 'none': 'none'));
				addLoc(div10, file$n, 87, 18, 3471);
				div11.className = "section svelte-1mmgffy";
				addLoc(div11, file$n, 79, 16, 2862);
				h31.className = "svelte-1mmgffy";
				addLoc(h31, file$n, 93, 18, 3821);
				...
				input10.max = 8;
				input10.step = 0.01;
				addLoc(input10, file$n, 94, 18, 3878);
				div12.className = "section svelte-1mmgffy";
				addLoc(div12, file$n, 92, 16, 3780);
				h32.className = "svelte-1mmgffy";
				addLoc(h32, file$n, 100, 18, 4257);
				...
				addLoc(input11, file$n, 101, 25, 4304);
				label9.className = "svelte-1mmgffy";
				addLoc(label9, file$n, 101, 18, 4297);
				...
				addLoc(input12, file$n, 102, 25, 4417);
				label10.className = "svelte-1mmgffy";
				addLoc(label10, file$n, 102, 18, 4410);
				addLoc(div13, file$n, 103, 18, 4524);
				...
				input13.max = "2";
				input13.step = "0.1";
				addLoc(input13, file$n, 104, 18, 4595);
				div14.className = "section svelte-1mmgffy";
				setStyle(div14, "display", (ctx.classHeatmap > -1 ? 'block' : 'none'));
				addLoc(div14, file$n, 99, 16, 4160);
				h33.className = "svelte-1mmgffy";
				addLoc(h33, file$n, 107, 18, 4752);
				addLoc(div15, file$n, 108, 18, 4788);
				addLoc(div16, file$n, 109, 18, 4834);
				addLoc(div17, file$n, 110, 18, 4880);
				div18.className = "section svelte-1mmgffy";
				addLoc(div18, file$n, 106, 16, 4712);
				div19.className = "grid-size";
				addLoc(div19, file$n, 77, 14, 2805);
				div20.className = "expand svelte-1mmgffy";
				addLoc(div20, file$n, 76, 12, 2759);
				...
				addLoc(button3, file$n, 116, 12, 5044);
				div22.className = "expand-toggle svelte-1mmgffy";
				addLoc(div22, file$n, 115, 10, 5004);
			...
			m: function mount(target, anchor) {
				...
				append(div23, text56);
				append(div23, div22);
				append(div22, button3);
				append(button3, text57);
			...
			p: function update(changed, _ctx) {
	          ...
	          ;
	           ...
	           !== void 0;
				...
				if ((changed.gcx) && text49_value !== (text49_value = format_1$1(ctx.gcx))) {
					setData(text49, text49_value);
				}

				if ((changed.gcy) && text52_value !== (text52_value = format_1$1(ctx.gcy))) {
					setData(text52, text52_value);
				}

				if ((changed.scale) && text55_value !== (text55_value = format_1$1(ctx.scale))) {
					setData(text55, text55_value);
				}

				if ((changed.showOptions) && text57_value !== (text57_value = ctx.showOptions ? 'fewer options' : 'more options')) {
	...
	function create_main_fragment$u(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div1, file$t, 9, 4, 277);
				addLoc(div2, file$t, 4, 2, 26);
				addLoc(br1, file$t, 12, 67, 672);
				h41.className = "svelte-4ghdgj";
				addLoc(h41, file$t, 12, 4, 609);
				div3.className = "atlas";
				addLoc(div3, file$t, 13, 4, 715);
	...
	function create_main_fragment$G(component, ctx) {
		var div4, div2, div0, text0, div1, text1, svg, path, text2, div3, div4_resize_listener, text3, atlasdataloader_updating = {};
	...
	function create_main_fragment$H(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(marker0, file$G, 20, 8, 544);
				setAttribute(path0, "d", "M 0 0 L 10 5 L 0 10 z");
				addLoc(path0, file$G, 41, 10, 1084);
				...
				addLoc(marker1, file$G, 32, 8, 847);
				addLoc(defs, file$G, 19, 6, 529);
				...
				addLoc(svg, file$G, 15, 4, 440);
				div2.className = "atlas svelte-14ap8kx";
				addLoc(div2, file$G, 11, 2, 185);
	...
	function left$1({l, width, gcx, gcy, scale, aspectRatio, w, r}) {
		return l * width;
	}

	function right$1({r, width}) {
		return r * width;
	}

	function top$1({t, height}) {
		return t * height;
	}

	function bottom$1({b, height}) {
		return b * height;
	}
	...
	function AtlasStaticReticle(options) {
		...
		if (!('width' in this._state)) console.warn("<AtlasStaticReticle> was created without expected data property 'width'");
		if (!('gcy' in this._state)) console.warn("<AtlasStaticReticle> was created without expected data property 'gcy'");

		if (!('height' in this._state)) console.warn("<AtlasStaticReticle> was created without expected data property 'height'");




		if (!('background' in this._state)) console.warn("<AtlasStaticReticle> was created without expected data property 'background'");
		...
		if (!('enableDragging' in this._state)) console.warn("<AtlasStaticReticle> was created without expected data property 'enableDragging'");
	...
	function create_main_fragment$P(component, ctx) {
		var h4, text1, div0, select0, select0_updating = false, text2, select1, select1_updating = false, text3, div7, div2, div1, text4, table, thead, tr0, th0, text5, th1, text6, th2, div3, text8, div4, text10, th3, div5, text12, div6, text14, tr1, td0, img, img_alt_value, text15, td1, text17, td2, raw0_value = ctx.c.noise[ctx.method][2], raw0_after, text18, text19, td3, raw1_value = ctx.c.noise[ctx.method][0], raw1_after, text20, raw2_value = ctx.c.noise[ctx.method][1], raw2_before, text21, td4, raw3_value = ctx.c.noise[ctx.method][5], raw3_after, text22, text23, td5, raw4_value = ctx.c.noise[ctx.method][3], raw4_after, text24, raw5_value = ctx.c.noise[ctx.method][4], raw5_before, raw5_after, text25, text26;
		...
		function select_block_type(ctx) {
			if (ctx.method == "static") return create_if_block$d;
		...
		return {
			c: function create() {
				...
				div3 = createElement("div");
				div3.textContent = "Success rate";
				text8 = createText("\n          ");
				div4 = createElement("div");
				div4.textContent = "Previously correctly classified images that the patch changed to the target class.";
				text10 = createText("\n        ");
				th3 = createElement("th");
				div5 = createElement("div");
				div5.textContent = "Probability change";
				text12 = createText("\n          ");
				div6 = createElement("div");
				div6.textContent = "Mean change in probabilty assigned to the target class.";
				text14 = createText("\n    ");
				...
				select0.className = "svelte-1va7hgh";
				addLoc(select0, file$O, 8, 2, 109);
				...
				select1.className = "svelte-1va7hgh";
				addLoc(select1, file$O, 14, 2, 343);
				div0.className = "controls svelte-1va7hgh";
				addLoc(div0, file$O, 7, 0, 84);
				addLoc(div1, file$O, 23, 4, 559);
				div2.className = "method-description svelte-1va7hgh";
				addLoc(div2, file$O, 22, 2, 522);
				th0.className = "svelte-1va7hgh";
				addLoc(th0, file$O, 40, 8, 1120);
				th1.className = "svelte-1va7hgh";
				addLoc(th1, file$O, 41, 8, 1138);
				addLoc(div3, file$O, 43, 10, 1183);
				div4.className = "figcaption svelte-1va7hgh";
				addLoc(div4, file$O, 44, 10, 1217);
				th2.colSpan = "2";
				th2.className = "svelte-1va7hgh";
				addLoc(th2, file$O, 42, 8, 1156);
				addLoc(div5, file$O, 47, 10, 1379);
				div6.className = "figcaption svelte-1va7hgh";
				addLoc(div6, file$O, 48, 10, 1419);
				th3.colSpan = "2";
				th3.className = "svelte-1va7hgh";
				addLoc(th3, file$O, 46, 8, 1352);
				addLoc(tr0, file$O, 39, 6, 1107);
				addLoc(thead, file$O, 38, 4, 1093);
				img.src = "assets/images/patches/random.png";
				img.alt = img_alt_value = "patch " + ctx.p;
				img.className = "svelte-1va7hgh";
				addLoc(img, file$O, 54, 8, 1572);
				td0.className = "svelte-1va7hgh";
				addLoc(td0, file$O, 53, 6, 1559);
				td1.className = "svelte-1va7hgh";
				addLoc(td1, file$O, 56, 6, 1652);
				td2.className = "svelte-1va7hgh";
				addLoc(td2, file$O, 57, 6, 1673);
				td3.className = "svelte-1va7hgh";
				addLoc(td3, file$O, 58, 6, 1716);
				td4.className = "svelte-1va7hgh";
				addLoc(td4, file$O, 59, 6, 1787);
				td5.className = "svelte-1va7hgh";
				addLoc(td5, file$O, 60, 6, 1830);
				addLoc(tr1, file$O, 52, 4, 1548);
				table.className = "svelte-1va7hgh";
				addLoc(table, file$O, 37, 2, 1081);
				div7.className = "method svelte-1va7hgh";
				addLoc(div7, file$O, 21, 0, 499);
			},
	...
	// (10:4) {#each comparisons as comparison, i}
	...
	// (16:4) {#each methods as method, i}
	function create_each_block_1$7(component, ctx) {
		var option, text0_value = ctx.method, text0, text1;

		return {
			c: function create() {
				option = createElement("option");
				text0 = createText(text0_value);
				text1 = createText(" positioning");
				option.__value = ctx.i;
				option.value = option.__value;
				addLoc(option, file$O, 16, 6, 419);
			},
			...
			p: function update(changed, ctx) {
				if ((changed.methods) && text0_value !== (text0_value = ctx.method)) {
					setData(text0, text0_value);
				}
			},
	...
	function create_else_block$2(component, ctx) {
		var div, p, text0, strong, text2, text3, img;

		return {
			c: function create() {
				div = createElement("div");
				p = createElement("p");
				text0 = createText("Choosing ");
				strong = createElement("strong");
				strong.textContent = "the strongest";
				text2 = createText(" size and corner position for each example.");
				text3 = createText("\n        ");
				img = createElement("img");
				addLoc(strong, file$O, 31, 39, 879);
				p.className = "figcaption";
				addLoc(p, file$O, 31, 8, 848);
				img.src = "assets/icon-dynamic.png";
				img.alt = "icon";
				setStyle(img, "width", "initial");
				addLoc(img, file$O, 32, 8, 965);
				addLoc(div, file$O, 30, 6, 834);
			},
	...
	function create_if_block$d(component, ctx) {
		...
		return {
			c: function create() {
				...
				text0 = createText("Choosing ");
				strong = createElement("strong");
				strong.textContent = "a consistent";
				text2 = createText(" size and corner position across all examples.");
				text3 = createText("\n        ");
				img = createElement("img");
				addLoc(strong, file$O, 26, 39, 645);
				p.className = "figcaption";
				addLoc(p, file$O, 26, 8, 614);
				img.src = "assets/icon-static.png";
				img.alt = "icon";
				setStyle(img, "width", "initial");
				addLoc(img, file$O, 27, 8, 733);
				addLoc(div, file$O, 25, 6, 600);
			},
	...
	function create_each_block$e(component, ctx) {
		...
		return {
			c: function create() {
				...
				img.alt = "patch " + ctx.p;
				img.className = "svelte-1va7hgh";
				addLoc(img, file$O, 74, 10, 2317);
				td0.className = "svelte-1va7hgh";
				addLoc(td0, file$O, 73, 8, 2302);
				td1.className = "svelte-1va7hgh";
				addLoc(td1, file$O, 76, 8, 2419);
				td2.className = "svelte-1va7hgh";
				addLoc(td2, file$O, 77, 8, 2468);
				td3.className = "svelte-1va7hgh";
				addLoc(td3, file$O, 78, 8, 2511);
				td4.className = "svelte-1va7hgh";
				addLoc(td4, file$O, 79, 8, 2580);
				td5.className = "svelte-1va7hgh";
				addLoc(td5, file$O, 80, 8, 2623);
				addLoc(tr, file$O, 72, 6, 2289);
			},
