	...
	function create_main_fragment$O(component, ctx) {
		...
		return {
			c: function create() {
				...
				h40.className = "svelte-qlmtti";
				addLoc(h40, file$N, 3, 4, 25);
				setStyle(h41, "width", "" + ctx.loupeSize + "px");
				h41.className = "svelte-qlmtti";
				addLoc(h41, file$N, 15, 4, 337);
				addLoc(div0, file$N, 29, 4, 682);
				div1.className = "figcaption svelte-qlmtti";
				addLoc(div1, file$N, 30, 4, 698);
				div2.className = "figcaption svelte-qlmtti";
				addLoc(div2, file$N, 33, 4, 836);
				div3.className = "figcaption svelte-qlmtti";
				addLoc(div3, file$N, 36, 4, 1003);
				div4.className = "figcaption svelte-qlmtti";
				addLoc(div4, file$N, 39, 4, 1180);
				div5.className = "root svelte-qlmtti";
	...
	function create_each_block_1$6(component, ctx) {
		...
		return {
			c: function create() {
				...
				lazyimage._fragment.c();
				loupe._fragment.c();
				div.className = "loupe svelte-qlmtti";
