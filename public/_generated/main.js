(function () {
	...
	function left({clientWidth, extent}) {
		return Math.max(0, extent[0][0] * clientWidth);
	}
	...
	function top({clientHeight, extent}) {
		return Math.max(0, extent[1][0] * clientHeight);
	}
	...
	function create_main_fragment$d(component, ctx) {
		...
		return {
			c: function create() {
				...
				if (if_block) if_block.c();
				component.root._beforecreate.push(div_resize_handler);
				div.className = "root svelte-4f0jmz";
	...
	function create_if_block$4(component, ctx) {
		...
		return {
			c: function create() {
				...
				setAttribute(path, "class", path_class_value = "" + (ctx.background ? '' : 'transparent') + " svelte-4f0jmz");
				...
				addLoc(path, file$d, 3, 4, 123);
				setAttribute(svg, "width", ctx.clientWidth);
				setAttribute(svg, "height", ctx.clientHeight);
				setAttribute(svg, "class", "svelte-4f0jmz");
				addLoc(svg, file$d, 2, 2, 71);
				...
				div.className = div_class_value = "reticle " + (ctx.round ? 'round' : '') + " svelte-4f0jmz";
			...
			p: function update(changed, ctx) {
				if ((changed.background) && path_class_value !== (path_class_value = "" + (ctx.background ? '' : 'transparent') + " svelte-4f0jmz")) {
				...
				if ((changed.round) && div_class_value !== (div_class_value = "reticle " + (ctx.round ? 'round' : '') + " svelte-4f0jmz")) {
					div.className = div_class_value;
				}
	...
	function create_if_block_1(component, ctx) {
		...
		return {
			c: function create() {
				...
				p.className = "annotation svelte-4f0jmz";
				addLoc(p, file$d, 27, 10, 921);
				div0.className = "annotationTab svelte-4f0jmz";
				setStyle(div0, "background", ctx.color);
				addLoc(div0, file$d, 26, 8, 855);
				div1.className = "annotationTabParent svelte-4f0jmz";
				setStyle(div1, "top", "" + (ctx.w * ctx.width-2)/2 + "px");
				addLoc(div1, file$d, 25, 6, 780);
			},
	...
	function create_main_fragment$e(component, ctx) {
		...
		return {
			c: function create() {
				...
				img.className = "svelte-14h5tvn";
				addLoc(img, file$e, 14, 4, 276);
				div.className = "svelte-14h5tvn svelte-ref-root";
	...
	function create_main_fragment$n(component, ctx) {
		var div24, div1, h20, text1, div0, appclassfilter_updating = {}, text2, div3, h21, text4, div2, applayerchooser_updating = {}, text5, div8, div7, atlas_updating = {}, text6, div6, div4, appminimap_updating = {}, text7, div5, text8, text9, text10, div23, h22, text12, div22, div12, div9, text13, raw0_value = format_1$1(ctx.gcx), raw0_before, text14, div10, text15, raw1_value = format_1$1(ctx.gcy), raw1_before, text16, div11, text17, raw2_value = format_1$1(ctx.scale), raw2_before, text18, label0, input0, text19, text20, div13, h30, text22, label1, input1, text23, text24, div16, h31, text26, label2, input2, text27, text28, label3, input3, text29, text30, label4, input4, text31, text32, label5, input5, text33, text34, label6, input6, text35, text36, label7, input7, text37, text38, div15, div14, text39, raw3_before, text40, input8, text41, div19, h32, text43, div17, text44, raw4_before, text45, input9, text46, br, text47, div18, text48, raw5_before, text49, input10, text50, div21, h33, text52, div20, text53, raw6_before, text54, input11, text55, label8, input12, text56, text57, label9, input13, text58;
		...
		function input8_change_input_handler() {
			component.set({ autoGridSizeMultiplier: toNumber(input8.value) });
		}

		function input9_change_input_handler() {
			component.set({ density: toNumber(input9.value) });
		}

		function input10_change_input_handler() {
			component.set({ iconCrop: toNumber(input10.value) });
		}

		function input11_change_input_handler() {
			component.set({ classHeatmapMultiplier: toNumber(input11.value) });
		}
		...
		function input13_change_handler() {
			component.set({ classHeatmapPositive: input13.__value });
		}
		...
		return {
			c: function create() {
				...
				text19 = createText(" scroll to zoom");
				text20 = createText("\n        ");
				...
				text56 = createText(" positive influence");
				text57 = createText("\n          ");
				label9 = createElement("label");
				input13 = createElement("input");
				text58 = createText(" negative influence");
				panel2._fragment.c();
				...
				addLoc(div4, file$m, 49, 10, 1279);
				div5.className = "buttons svelte-1rc1tnm";
				addLoc(div5, file$m, 59, 10, 1609);
				div6.className = "svelte-1rc1tnm svelte-ref-controls";
				addLoc(div6, file$m, 48, 8, 1250);
				...
				input8.max = 1.4;
				input8.step = 0.01;
				addLoc(input8, file$m, 93, 12, 3337);
				setStyle(div15, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div15, file$m, 91, 10, 3196);
				div16.className = "grid-size";
				addLoc(div16, file$m, 83, 8, 2649);
				addLoc(h32, file$m, 97, 10, 3480);
				addLoc(div17, file$m, 98, 10, 3505);
				...
				input9.max = 8;
				input9.step = 0.01;
				addLoc(input9, file$m, 99, 10, 3551);
				addLoc(br, file$m, 100, 10, 3631);
				addLoc(div18, file$m, 101, 10, 3646);
				...
				input10.max = 0.5;
				input10.step = 0.01;
				addLoc(input10, file$m, 102, 10, 3690);
				addLoc(div19, file$m, 96, 8, 3464);
				addLoc(h33, file$m, 105, 10, 3856);
				addLoc(div20, file$m, 106, 10, 3888);
				...
				input11.max = "2";
				input11.step = "0.1";
				addLoc(input11, file$m, 107, 10, 3951);
				...
				addLoc(input12, file$m, 108, 17, 4046);
				label8.className = "svelte-1rc1tnm";
				addLoc(label8, file$m, 108, 10, 4039);
				...
				addLoc(input13, file$m, 109, 17, 4151);
				label9.className = "svelte-1rc1tnm";
				addLoc(label9, file$m, 109, 10, 4144);
				setStyle(div21, "display", (ctx.classHeatmap > -1 ? 'block' : 'none'));
				addLoc(div21, file$m, 104, 8, 3784);
				setAttribute(div22, "slot", "body");
				div22.className = "options-body svelte-1rc1tnm";
				addLoc(div22, file$m, 71, 6, 2206);
				div23.className = "options svelte-1rc1tnm";
				setStyle(div23, "display", (ctx.showOptions ? 'block' : 'none'));
				addLoc(div23, file$m, 68, 2, 2080);
				div24.className = "container svelte-1rc1tnm";
				addLoc(div24, file$m, 0, 0, 0);
			},
			...
			m: function mount(target, anchor) {
				...
				append(panel2._slotted.body, div22);
				append(div22, div12);
				append(div12, div9);
				append(div9, text13);
				...
				append(label7, text37);
				append(div16, text38);
				append(div16, div15);
				append(div15, div14);
				append(div14, text39);
				append(div14, raw3_before);
				raw3_before.insertAdjacentHTML("afterend", ctx.autoGridSizeMultiplier);
				append(div15, text40);
				append(div15, input8);

				input8.value = ctx.autoGridSizeMultiplier;
				...
				raw4_before.insertAdjacentHTML("afterend", ctx.density);
				append(div19, text45);
				append(div19, input9);

				input9.value = ctx.density;
				...
				raw5_before.insertAdjacentHTML("afterend", ctx.iconCrop);
				append(div19, text49);
				append(div19, input10);

				input10.value = ctx.iconCrop;
				...
				append(div21, div20);
				append(div20, text53);
				append(div20, raw6_before);
				raw6_before.insertAdjacentHTML("afterend", ctx.classHeatmapMultiplier);
				append(div21, text54);
				append(div21, input11);

				input11.value = ctx.classHeatmapMultiplier;
				...
				append(label8, text56);
				append(div21, text57);
				append(div21, label9);
				append(label9, input13);

				input13.checked = input13.__value === ctx.classHeatmapPositive;

				append(label9, text58);
				panel2._mount(div23, null);
			},
			...
			p: function update(changed, _ctx) {
	          ...
	          ;
	           ...
	           !== void 0;
				...
				if ((changed.gcx) && raw0_value !== (raw0_value = format_1$1(ctx.gcx))) {
					detachAfter(raw0_before);
					raw0_before.insertAdjacentHTML("afterend", raw0_value);
				}

				if ((changed.gcy) && raw1_value !== (raw1_value = format_1$1(ctx.gcy))) {
					detachAfter(raw1_before);
					raw1_before.insertAdjacentHTML("afterend", raw1_value);
				}

				if ((changed.scale) && raw2_value !== (raw2_value = format_1$1(ctx.scale))) {
				...
				if (changed.autoGridSizeMultiplier) input8.value = ctx.autoGridSizeMultiplier;
				if (changed.gridSize) {
					setStyle(div15, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				}
				...
				if (changed.density) input9.value = ctx.density;
				if (changed.iconCrop) {
					detachAfter(raw5_before);
					raw5_before.insertAdjacentHTML("afterend", ctx.iconCrop);
				}

				if (changed.iconCrop) input10.value = ctx.iconCrop;
				if (changed.classHeatmapMultiplier) {
					detachAfter(raw6_before);
					raw6_before.insertAdjacentHTML("afterend", ctx.classHeatmapMultiplier);
				}

				if (changed.classHeatmapMultiplier) input11.value = ctx.classHeatmapMultiplier;
				if (changed.classHeatmapPositive) input12.checked = input12.__value === ctx.classHeatmapPositive;
				if (changed.classHeatmapPositive) input13.checked = input13.__value === ctx.classHeatmapPositive;
				if (changed.classHeatmap) {
					setStyle(div21, "display", (ctx.classHeatmap > -1 ? 'block' : 'none'));
				}
			...
			d: function destroy$$1(detach) {
				...
				component._bindingGroups[1].splice(component._bindingGroups[1].indexOf(input13), 1);
				removeListener(input13, "change", input13_change_handler);
				panel2.destroy();
			}
		};
	}
