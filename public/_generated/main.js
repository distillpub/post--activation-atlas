	  ...
	  ;
		...
		return {
			c: function create() {
				...
				addLoc(div1, file$F, 3, 4, 231);
				setAttribute(path, "d", "M 0 0 L 10 5 L 0 10 z");
				setAttribute(path, "fill", ctx.color);
				addLoc(path, file$F, 5, 6, 429);
