(function () {
	...
	function create_main_fragment$d(component, ctx) {
		...
		var if_block = (ctx.scale) && create_if_block$4(component, ctx);
	...
	function create_main_fragment$e(component, ctx) {
		...
		return {
			c: function create() {
				...
				img.className = "svelte-1xmqpef";
				addLoc(img, file$e, 14, 4, 276);
				div.className = "svelte-1xmqpef svelte-ref-root";
	...
	function w$1({viewWidth, screenResolution}) {
		return viewWidth * screenResolution;
	}

	function h$1({viewHeight, screenResolution}) {
	...
	function create_main_fragment$n(component, ctx) {
		var div24, div1, h20, text1, div0, appclassfilter_updating = {}, text2, div3, h21, text4, div2, applayerchooser_updating = {}, text5, div8, div7, atlas_updating = {}, text6, div6, div4, appminimap_updating = {}, text7, div5, text8, text9, text10, div23, h22, text12, div22, div12, div9, text13, raw0_value = format_1$1(ctx.gcx), raw0_before, text14, div10, text15, raw1_value = format_1$1(ctx.gcy), raw1_before, text16, div11, text17, raw2_value = format_1$1(ctx.scale), raw2_before, text18, div13, h30, text20, label0, input0, text21, text22, div16, h31, text24, label1, input1, text25, text26, label2, input2, text27, text28, label3, input3, text29, text30, label4, input4, text31, text32, label5, input5, text33, text34, label6, input6, text35, text36, div15, div14, text37, raw3_before, text38, input7, text39, div19, h32, text41, div17, text42, raw4_before, text43, input8, text44, br, text45, div18, text46, raw5_before, text47, input9, text48, div21, h33, text50, div20, text51, raw6_before, text52, input10, text53, label7, input11, text54, text55, label8, input12, text56;
		...
		component.root._beforecreate.push(() => {
			atlas._bind({ density: 1, iconCrop: 1, classHeatmapMultiplier: 1, classHeatmapPositive: 1, autoGridSizeMultiplier: 1, gridSize: 1, showLabels: 1, scale: 1, aspectRatio: 1, gcx: 1, gcy: 1 }, atlas.get());
		});
		...
		function input7_change_input_handler() {
			component.set({ autoGridSizeMultiplier: toNumber(input7.value) });
		}

		function input8_change_input_handler() {
			component.set({ density: toNumber(input8.value) });
		}

		function input9_change_input_handler() {
			component.set({ iconCrop: toNumber(input9.value) });
		}
		...
		return {
			c: function create() {
				...
				text35 = createText(" auto");
				text36 = createText("\n          ");
				div15 = createElement("div");
				div14 = createElement("div");
				text37 = createText("auto threshold: ");
				...
				text54 = createText(" positive influence");
				text55 = createText("\n          ");
				label8 = createElement("label");
				input12 = createElement("input");
				text56 = createText(" negative influence");
				panel2._fragment.c();
				...
				addLoc(div4, file$m, 47, 10, 1230);
				div5.className = "buttons svelte-1rc1tnm";
				addLoc(div5, file$m, 60, 10, 1635);
				div6.className = "svelte-1rc1tnm svelte-ref-controls";
				addLoc(div6, file$m, 46, 8, 1201);
				...
				input7.max = 1.4;
				input7.step = 0.01;
				addLoc(input7, file$m, 93, 12, 3276);
				setStyle(div15, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div15, file$m, 91, 10, 3135);
				div16.className = "grid-size";
				addLoc(div16, file$m, 83, 8, 2588);
				addLoc(h32, file$m, 97, 10, 3419);
				addLoc(div17, file$m, 98, 10, 3444);
				...
				input8.max = 8;
				input8.step = 0.01;
				addLoc(input8, file$m, 99, 10, 3490);
				addLoc(br, file$m, 100, 10, 3570);
				addLoc(div18, file$m, 101, 10, 3585);
				...
				input9.max = 0.5;
				input9.step = 0.01;
				addLoc(input9, file$m, 102, 10, 3629);
				addLoc(div19, file$m, 96, 8, 3403);
				addLoc(h33, file$m, 105, 10, 3795);
				addLoc(div20, file$m, 106, 10, 3827);
				...
				input10.max = "2";
				input10.step = "0.1";
				addLoc(input10, file$m, 107, 10, 3890);
				...
				addLoc(input11, file$m, 108, 17, 3985);
				label7.className = "svelte-1rc1tnm";
				addLoc(label7, file$m, 108, 10, 3978);
			...
			m: function mount(target, anchor) {
				...
				input7.value = ctx.autoGridSizeMultiplier;
			...
			p: function update(changed, _ctx) {
	          ...
	          ;
	           ...
	           !== void 0;
				...
				if (changed.autoGridSizeMultiplier) input7.value = ctx.autoGridSizeMultiplier;
				if (changed.gridSize) {
					setStyle(div15, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				}
				...
				if (changed.density) input8.value = ctx.density;
				if (changed.iconCrop) {
					detachAfter(raw5_before);
					raw5_before.insertAdjacentHTML("afterend", ctx.iconCrop);
				}

				if (changed.iconCrop) input9.value = ctx.iconCrop;
