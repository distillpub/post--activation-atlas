(function () {
	...
	function src({root, classFilter, gridSize, filterType}) {
		return `${root}render--x=0--y=0--tries=3--alpha=False--tile_size=8--whiten=true--steps=2048--icon_size=80--grid_size=${gridSize}--layout=20_0.01_cosine--class_filter=${classFilter}_${filterType}--filter=None--layer=mixed5b--model=InceptionV1--sample_images=1000000--sample_type=random.jpg`;
	}
