(function () {
	...
	const file$H = "src/diagrams/Focus1Static.html";
	...
	function create_main_fragment$I(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div1, file$H, 14, 2, 363);
				div2.className = "figcaption svelte-drlr3g";
				addLoc(div2, file$H, 19, 2, 516);
	...
	const file$I = "src/diagrams/Focus2Static.html";
	...
	function create_main_fragment$J(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div1, file$I, 45, 4, 1320);
				div2.className = "detail svelte-1smkqjl";
				addLoc(div2, file$I, 35, 2, 902);
	...
	const file$J = "src/diagrams/Focus3Static.html";
	...
	const file$K = "src/diagrams/Focus3TableStatic.html";
