(function () {
	...
	const file$4 = "src/library/Button.html";
	...
	const file$5 = "src/library/icons/svg/baseline-add-24px.svg";
	...
	const file$6 = "src/library/icons/svg/baseline-remove-24px.svg";
	...
	function create_main_fragment$6(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(path0, file$6, 0, 83, 83);
				setAttribute(path1, "d", "M0 0h24v24H0z");
				setAttribute(path1, "fill", "none");
				addLoc(path1, file$6, 0, 112, 112);
				setAttribute(svg, "xmlns", "http://www.w3.org/2000/svg");
				setAttribute(svg, "width", "24");
				setAttribute(svg, "height", "24");
				setAttribute(svg, "viewBox", "0 0 24 24");
	...
	const file$7 = "src/library/icons/svg/baseline-home-24px.svg";
	...
	const file$8 = "src/library/icons/Navigation.html";
	...
	const file$b = "src/components/Figure.html";
	...
	function create_if_block_2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(tr0, file$c, 50, 10, 1429);
				td0.className = "svelte-ptap6b";
				addLoc(td0, file$c, 55, 12, 1698);
				setStyle(td1, "text-align", "right");
				td1.className = "svelte-ptap6b";
				addLoc(td1, file$c, 56, 12, 1777);
				addLoc(tr1, file$c, 54, 10, 1681);
			},
	...
	function create_each_block(component, ctx) {
		...
		return {
			c: function create() {
				...
				td0.className = "svelte-ptap6b";
				addLoc(td0, file$c, 61, 14, 2004);
				td1.className = "" + (ctx.i == 0 ? 'first': '') + " svelte-ptap6b";
				addLoc(td1, file$c, 62, 14, 2096);
				setStyle(td2, "text-align", "right");
				td2.className = "svelte-ptap6b";
				addLoc(td2, file$c, 63, 14, 2164);
				addLoc(tr, file$c, 60, 12, 1985);
			},
	...
	function create_if_block_1(component, ctx) {
		...
		return {
			c: function create() {
				canvas = createElement("canvas");
				addLoc(canvas, file$c, 69, 10, 2359);
			},
	...
	const file$e = "src/library/Placeholder.html";
	...
	function create_main_fragment$l(component, ctx) {
		var div19, div1, h30, text1, div0, appclassfilter_updating = {}, text2, div3, h31, text4, div2, applayerchooser_updating = {}, text5, div8, div7, atlas_updating = {}, text6, div6, div4, appminimap_updating = {}, text7, div5, text8, text9, text10, div18, h32, text12, div17, div12, div9, text13, raw0_value = format_1(ctx.gcx), raw0_before, text14, div10, text15, raw1_value = format_1(ctx.gcy), raw1_before, text16, div11, text17, raw2_value = format_1(ctx.scale), raw2_before, text18, div13, h40, text20, label0, input0, text21, text22, div14, h41, text24, label1, input1, text25, text26, label2, input2, text27, text28, label3, input3, text29, text30, label4, input4, text31, text32, label5, input5, text33, text34, div15, h42, text35, text36, text37, input6, text38, br0, text39, h43, text40, text41, text42, input7, text43, div16, h44, text44, text45, text46, input8, text47, br1, text48, h45, text50, br2, text51, label6, input9, text52, text53, br3, text54, label7, input10, text55;
		...
		return {
			c: function create() {
				...
				text36 = createText(ctx.iconScaleFactor);
				text37 = createText("\n          ");
				...
				text40 = createText("icon crop: ");
				text41 = createText(ctx.iconCrop);
				text42 = createText("\n          ");
				input7 = createElement("input");
				text43 = createText("\n        ");
				div16 = createElement("div");
				h44 = createElement("h4");
				text44 = createText("class filter intensity: ");
				text45 = createText(ctx.classHeatmapMultiplier);
				text46 = createText("\n          ");
				...
				input6.max = 10;
				input6.step = 0.1;
				addLoc(input6, file$k, 90, 10, 2934);
				addLoc(br0, file$k, 91, 10, 3022);
				h43.className = "svelte-z55voj";
				addLoc(h43, file$k, 92, 10, 3037);
				...
				input7.max = 0.5;
				input7.step = 0.01;
				addLoc(input7, file$k, 93, 10, 3078);
				addLoc(div15, file$k, 88, 8, 2867);
				h44.className = "svelte-z55voj";
				addLoc(h44, file$k, 96, 10, 3244);
				...
				input8.max = "2";
				input8.step = "0.1";
				addLoc(input8, file$k, 97, 10, 3312);
				addLoc(br1, file$k, 98, 10, 3400);
				h45.className = "svelte-z55voj";
				addLoc(h45, file$k, 99, 10, 3415);
				addLoc(br2, file$k, 100, 10, 3465);
				...
				addLoc(input9, file$k, 101, 17, 3487);
				addLoc(label6, file$k, 101, 10, 3480);
				addLoc(br3, file$k, 102, 10, 3585);
	...
	const file$l = "src/library/LazyImage.html";
	...
	const file$m = "src/diagrams/Overview.html";
	...
	function create_main_fragment$n(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(h40, file$m, 2, 4, 27);
				div0.className = "figcaption svelte-7yn287";
				addLoc(div0, file$m, 7, 4, 148);
				addLoc(div1, file$m, 1, 2, 17);
				h41.className = "svelte-7yn287";
				addLoc(h41, file$m, 10, 4, 312);
				div2.className = "figcaption svelte-7yn287";
				addLoc(div2, file$m, 15, 4, 438);
				addLoc(div3, file$m, 9, 2, 302);
				h42.className = "svelte-7yn287";
				addLoc(h42, file$m, 18, 4, 638);
				div4.className = "figcaption svelte-7yn287";
				addLoc(div4, file$m, 23, 4, 760);
				addLoc(div5, file$m, 17, 2, 628);
				h43.className = "svelte-7yn287";
				addLoc(h43, file$m, 26, 4, 913);
				div6.className = "figcaption svelte-7yn287";
				addLoc(div6, file$m, 31, 4, 1031);
				addLoc(div7, file$m, 25, 2, 903);
				div8.className = "svelte-7yn287 svelte-ref-root";
				addLoc(div8, file$m, 0, 0, 0);
			},
	...
	const file$n = "src/diagrams/ModelOverview.html";
	...
	const file$o = "src/diagrams/GridDetail.html";
	...
	function create_main_fragment$p(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$o, 7, 4, 116);
				addLoc(div1, file$o, 2, 2, 22);
				div2.className = "figcaption svelte-scrtb8";
				addLoc(div2, file$o, 14, 4, 287);
				addLoc(div3, file$o, 9, 2, 184);
				div4.className = "root svelte-scrtb8";
				addLoc(div4, file$o, 1, 0, 1);
			},
	...
	const file$p = "src/diagrams/ClassAtlas.html";
	...
	const file$q = "src/diagrams/ClassSubset.html";
	...
	function create_main_fragment$s(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(h41, file$r, 14, 4, 449);
				div2.className = "atlas";
				addLoc(div2, file$r, 15, 4, 495);
				addLoc(div3, file$r, 13, 2, 439);
	...
	function create_main_fragment$v(component, ctx) {
		...
		return {
			c: function create() {
				...
				text7 = createText("\n    ");
				lazyimage2._fragment.c();
				addLoc(h40, file$u, 2, 4, 27);
				addLoc(div0, file$u, 1, 2, 17);
				addLoc(h41, file$u, 9, 4, 430);
				addLoc(div1, file$u, 8, 2, 420);
				addLoc(h42, file$u, 16, 4, 836);
				addLoc(div2, file$u, 15, 2, 826);
	...
	const file$J = "src/AtlasStack.html";
	...
	const file$K = "src/diagrams/FocusPlayground.html";
	...
	function create_main_fragment$L(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$K, 2, 2, 27);
				div1.className = "layer-chooser svelte-1rdkii";
				addLoc(div1, file$K, 8, 2, 239);
				addLoc(button0, file$K, 14, 6, 391);
				addLoc(button1, file$K, 15, 6, 422);
				div2.className = "resolution";
				addLoc(div2, file$K, 13, 4, 360);
				div3.className = "atlas svelte-1rdkii";
				addLoc(div3, file$K, 17, 4, 463);
				div4.className = "display svelte-1rdkii";
				addLoc(div4, file$K, 12, 2, 334);
				div5.className = "container svelte-1rdkii";
				addLoc(div5, file$K, 1, 0, 1);
			},
	...
	const file$L = "src/diagrams/ClassComparisonSingle.html";
	...
	function create_main_fragment$M(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$L, 10, 4, 356);
				b0.className = "svelte-eedxs5";
				addLoc(b0, file$L, 13, 28, 522);
				div1.className = "figcaption svelte-eedxs5";
				addLoc(div1, file$L, 13, 4, 498);
				addLoc(div2, file$L, 9, 2, 346);
				div3.className = "atlas svelte-eedxs5";
				addLoc(div3, file$L, 16, 4, 565);
				b1.className = "svelte-eedxs5";
				addLoc(b1, file$L, 19, 28, 732);
				div4.className = "figcaption svelte-eedxs5";
				addLoc(div4, file$L, 19, 4, 708);
				addLoc(div5, file$L, 15, 2, 555);
