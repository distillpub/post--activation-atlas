(function () {
	...
	const file$h = "src/components/App.html";
	...
	function App(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["scroll"]), data$e()), options.data);
	...
	const file$i = "src/library/Tooltip.html";
	...
	const file$j = "src/components/AtlasTooltip.html";
	...
	function create_each_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(td0, file$j, 5, 8, 126);
				td1.className = "" + (ctx.i == 0 ? 'first': '') + " svelte-1qbcldy";
				addLoc(td1, file$j, 6, 8, 212);
				setStyle(td2, "text-align", "right");
				td2.className = "svelte-1qbcldy";
				addLoc(td2, file$j, 7, 8, 284);
				addLoc(tr, file$j, 4, 6, 113);
			},
