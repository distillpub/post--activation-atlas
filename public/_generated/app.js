	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				input8.max = 1.4;
				input8.step = 0.01;
				addLoc(input8, file$g, 84, 20, 3278);
				setStyle(div9, "display", (ctx.gridSize == -1 ? 'none': 'none'));
				addLoc(div9, file$g, 82, 18, 3122);
				div10.className = "section svelte-1xmf6n";
				addLoc(div10, file$g, 74, 16, 2513);
				h31.className = "svelte-1xmf6n";
				addLoc(h31, file$g, 88, 18, 3472);
				...
				input9.max = 8;
				input9.step = 0.01;
				addLoc(input9, file$g, 89, 18, 3529);
				div11.className = "section svelte-1xmf6n";
				addLoc(div11, file$g, 87, 16, 3431);
				h32.className = "svelte-1xmf6n";
				addLoc(h32, file$g, 95, 18, 3908);
				...
				addLoc(input10, file$g, 96, 25, 3955);
				label8.className = "svelte-1xmf6n";
				addLoc(label8, file$g, 96, 18, 3948);
				...
				addLoc(input11, file$g, 97, 25, 4068);
				label9.className = "svelte-1xmf6n";
				addLoc(label9, file$g, 97, 18, 4061);
				addLoc(div12, file$g, 98, 18, 4175);
				...
				addLoc(div18, file$g, 72, 14, 2456);
				div19.className = "expand svelte-1xmf6n";
				addLoc(div19, file$g, 71, 12, 2410);
				...
				addLoc(div23, file$g, 23, 4, 611);
				div24.className = "main svelte-1xmf6n";
				addLoc(div24, file$g, 22, 2, 588);
				div25.className = "container svelte-1xmf6n";
				addLoc(div25, file$g, 0, 0, 0);
			},
			...
			p: function update(changed, _ctx) {
	          ...
	          ;
	           ...
	           !== void 0;
				...
				if ((changed.gcx) && text47_value !== (text47_value = format_1(ctx.gcx))) {
					setData(text47, text47_value);
				}

				if ((changed.gcy) && text50_value !== (text50_value = format_1(ctx.gcy))) {
					setData(text50, text50_value);
				}

				if ((changed.scale) && text53_value !== (text53_value = format_1(ctx.scale))) {
