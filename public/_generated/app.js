(function () {
	...
	function create_main_fragment$k(component, ctx) {
		...
		return {
			c: function create() {
				...
				input9.max = 1.4;
				input9.step = 0.01;
				addLoc(input9, file$j, 89, 20, 3627);
				setStyle(div10, "display", (ctx.gridSize == -1 ? 'none': 'none'));
				addLoc(div10, file$j, 87, 18, 3471);
				div11.className = "section svelte-1mmgffy";
				addLoc(div11, file$j, 79, 16, 2862);
				h31.className = "svelte-1mmgffy";
				addLoc(h31, file$j, 93, 18, 3821);
				...
				input10.max = 8;
				input10.step = 0.01;
				addLoc(input10, file$j, 94, 18, 3878);
				div12.className = "section svelte-1mmgffy";
				addLoc(div12, file$j, 92, 16, 3780);
				h32.className = "svelte-1mmgffy";
				addLoc(h32, file$j, 100, 18, 4257);
				...
				addLoc(input11, file$j, 101, 25, 4304);
				label9.className = "svelte-1mmgffy";
				addLoc(label9, file$j, 101, 18, 4297);
				...
				addLoc(input12, file$j, 102, 25, 4417);
				label10.className = "svelte-1mmgffy";
				addLoc(label10, file$j, 102, 18, 4410);
				addLoc(div13, file$j, 103, 18, 4524);
			...
			p: function update(changed, _ctx) {
	          ...
	          ;
	           ...
	           !== void 0;
				...
				if ((changed.gcx) && text49_value !== (text49_value = format_1(ctx.gcx))) {
					setData(text49, text49_value);
				}

				if ((changed.gcy) && text52_value !== (text52_value = format_1(ctx.gcy))) {
					setData(text52, text52_value);
				}

				if ((changed.scale) && text55_value !== (text55_value = format_1(ctx.scale))) {
	...
	function create_main_fragment$m(component, ctx) {
		...
		var if_block = (ctx.component) && create_if_block$3(component, ctx);
	...
	function create_main_fragment$n(component, ctx) {
		...
		var if_block = (ctx.top_class_indices) && create_if_block$4(component, ctx);
