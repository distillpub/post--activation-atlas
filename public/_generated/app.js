(function () {
	...
	function create_main_fragment$k(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(input1, file$j, 72, 91, 2537);
	...
	const file$k = "src/library/Tooltip.html";
	...
	const file$l = "src/components/AtlasTooltip.html";
	...
	function create_each_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(td0, file$l, 5, 8, 126);
				td1.className = "" + (ctx.i == 0 ? 'first': '') + " svelte-1qbcldy";
				addLoc(td1, file$l, 6, 8, 212);
				setStyle(td2, "text-align", "right");
				td2.className = "svelte-1qbcldy";
				addLoc(td2, file$l, 7, 8, 284);
				addLoc(tr, file$l, 4, 6, 113);
			},
