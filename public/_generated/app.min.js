...
{changed:J({},this._state),current:this._state})});a.target&&(this._fragment.c(),this._mount(a.target,a.anchor),E(this))}function Oi(){console.log("AppStandalone!");setTimeout(()=>{this.refs.app.home(0)},100)}function Pi(a,b){function c(){a.set({clientWidth:d.offsetWidth,clientHeight:d.offsetHeight})}var d,e,f=new gb({root:a.root,store:a.store,data:{clientWidth:b.clientWidth,clientHeight:b.clientHeight,gridSize:-1,showLabels:!0,shareLink:!0,backLink:b.backLink}});a.refs.app=f;return{c(){d=k("div");
f._fragment.c();a.root._beforecreate.push(c);q(d,"width","100%");q(d,"height","100%")},m(a,b){a.insertBefore(d,b);f._mount(d,null);e=uf(d,c)},p(a,b){var c={};a.clientWidth&&(c.clientWidth=b.clientWidth);a.clientHeight&&(c.clientHeight=b.clientHeight);a.backLink&&(c.backLink=b.backLink);f._set(c)},d(b){b&&v(d);f.destroy();a.refs.app===f&&(a.refs.app=null);e.cancel()}}}function Xe(a){x(this,a);this.refs={};this._state=r({backLink:void 0},a.data);this._intro=!0;this._fragment=Pi(this,this._state);this.root._oncreate.push(()=>
{Oi.call(this);this.fire("update",{changed:J({},this._state),current:this._state})});a.target&&(this._fragment.c(),this._mount(a.target,a.anchor),E(this))}function Qi({x:a,width:b,y:c,height:d,visible:e}){if(!1===e)return"display: none;";{e=document.documentElement.scrollLeft;let f=Math.max(window.pageYOffset,document.documentElement.scrollTop,document.body.scrollTop),g=document.documentElement.clientWidth-b;d=document.documentElement.clientHeight-d;let h=Math.min(a,g),l=Math.min(c,d);a>=g&&c>=d&&
(h=a-b);return`width: ${b}px; top: ${l+f}px; left: ${h+e}px;`}}function Ri(a,b){function c(b){a.mousemove(b)}function d(b){a.hide()}var e,f;document.addEventListener("mousemove",c);document.addEventListener("scroll",d);var g=b.component&&Ye(a,b);return{c(){e=n("\n\n");f=k("div");g&&g.c();f.style.cssText=b.style;f.className="svelte-14z2oof svelte-ref-root"},m(b,c){b.insertBefore(e,c);b.insertBefore(f,c);g&&g.m(f,null);a.refs.root=f},p(b,c){c.component?g?g.p(b,c):(g=Ye(a,c),g.c(),g.m(f,null)):g&&(g.d(1),
g=null);b.style&&(f.style.cssText=c.style)},d(b){document.removeEventListener("mousemove",c);document.removeEventListener("scroll",d);b&&(v(e),v(f));g&&g.d();a.refs.root===f&&(a.refs.root=null)}}}function Ye(a,b){var c,d=b.component;if(d)var e=new d({root:a.root,store:a.store});return{c(){e&&e._fragment.c();c=document.createComment("")},m(b,d){e&&(e._mount(b,d),a.refs.component=e);b.insertBefore(c,d)},p(b,g){d!==(d=g.component)&&(e&&e.destroy(),d?(e=new d({root:a.root,store:a.store}),e._fragment.c(),
e._mount(c.parentNode,c),a.refs.component=e):(e=null,a.refs.component===e&&(a.refs.component=null)))},d(a){a&&v(c);e&&e.destroy(a)}}}function Lb(a){x(this,a);this.refs={};this._state=r({visible:!1,width:150,height:200,component:null},a.data);this._recompute({x:1,width:1,y:1,height:1,visible:1},this._state);this._intro=!0;this._fragment=Ri(this,this._state);a.target&&(this._fragment.c(),this._mount(a.target,a.anchor),E(this))}function Ze(a,b,c){a=Object.create(a);a.top=b[c];a.i=c;return a}function Si(a,
b){var c,d,e,f,g,h=$e(b.num_activations),l,p,m=b.top_class_indices&&af(a,b);return{c(){c=k("div");d=k("table");m&&m.c();e=n("\n  ");f=k("div");g=n("Average of ");l=n(h);p=n(" activations");d.className="svelte-1qbcldy";q(f,"font-size","10px");q(f,"margin-top","4px");q(f,"color","#999");q(f,"text-align","right");c.className="hover svelte-1qbcldy"},m(a,b){a.insertBefore(c,b);c.appendChild(d);m&&m.m(d,null);c.appendChild(e);c.appendChild(f);f.appendChild(g);f.appendChild(l);f.appendChild(p)},p(b,c){c.top_class_indices?
m?m.p(b,c):(m=af(a,c),m.c(),m.m(d,null)):m&&(m.d(1),m=null);b.num_activations&&h!==(h=$e(c.num_activations))&&(l.data=""+h)},d(a){a&&v(c);m&&m.d()}}}function af(a,b){for(var c,d=b.top_class_indices.slice(0,5),e=[],f=0;f<d.length;f+=1)e[f]=bf(a,Ze(b,d,f));return{c(){for(var a=0;a<e.length;a+=1)e[a].c();c=document.createComment("")},m(a,b){for(var d=0;d<e.length;d+=1)e[d].m(a,b);a.insertBefore(c,b)},p(b,f){if(b.top_class_values||b.$inceptionLabels||b.top_class_indices){d=f.top_class_indices.slice(0,
5);for(var g=0;g<d.length;g+=1){let h=Ze(f,d,g);e[g]?e[g].p(b,h):(e[g]=bf(a,h),e[g].c(),e[g].m(c.parentNode,c))}for(;g<e.length;g+=1)e[g].d(1);e.length=d.length}},d(a){jb(e,a);a&&v(c)}}}function bf(a,b){var c,d,e=b.i+1,f,g,h,l,p=b.$inceptionLabels[b.top],m,A,r,t=cf(b.top_class_values[b.i]),u;return{c(){c=k("tr");d=k("td");f=n(e);g=n(".");h=n("\n        ");l=k("td");m=n(p);A=n("\n        ");r=k("td");u=n(t);q(d,"width","10px");q(d,"text-align","right");q(d,"padding-right","4px");d.className="svelte-1qbcldy";
l.className=(0==b.i?"first":"")+" svelte-1qbcldy";q(r,"text-align","right");r.className="svelte-1qbcldy"},m(a,b){a.insertBefore(c,b);c.appendChild(d);d.appendChild(f);d.appendChild(g);c.appendChild(h);c.appendChild(l);l.appendChild(m);c.appendChild(A);c.appendChild(r);r.appendChild(u)},p(a,b){(a.$inceptionLabels||a.top_class_indices)&&p!==(p=b.$inceptionLabels[b.top])&&(m.data=""+p);a.top_class_values&&t!==(t=cf(b.top_class_values[b.i]))&&(u.data=""+t)},d(a){a&&v(c)}}}function df(a){x(this,a);this._state=
r(this.store._init(["inceptionLabels"]),a.data);this.store._add(this,["inceptionLabels"]);this._intro=!0;this._handlers.destroy=[td];this._fragment=Si(this,this._state);a.target&&(this._fragment.c(),this._mount(a.target,a.anchor))}var w={destroy:function(a){this.destroy=C;this.fire("destroy");this.set=C;this._fragment.d(!1!==a);this._fragment=null;this._state={}},get:rd,fire:qd,on:sd,set:function(a){this._set(r({},a));this.root._lock||E(this.root)},_recompute:C,_set:function(a){var b=this._state,
c={},d=!1;a=r(this._staged,a);this._staged={};for(var e in a)this._differs(a[e],b[e])&&(c[e]=d=!0);d&&(this._state=r(r({},b),a),this._recompute(c,this._state),this._bind&&this._bind(c,this._state),this._fragment&&(this.fire("state",{changed:c,current:this._state,previous:b}),this._fragment.p(c,this._state),this.fire("update",{changed:c,current:this._state,previous:b})))},_stage:function(a){r(this._staged,a)},_mount:function(a,b){this._fragment[this._fragment.i?"i":"m"](a,b||null)},_differs:pd};r(ud.prototype,
{_add(a,b){this._dependents.push({component:a,props:b})},_init(a){let b={};for(let c=0;c<a.length;c+=1){let d=a[c];b["$"+d]=this._state[d]}return b},_remove(a){let b=this._dependents.length;for(;b--;)if(this._dependents[b].component===a){this._dependents.splice(b,1);break}},_set(a,b){let c=this._state;this._state=r(r({},c),a);for(a=0;a<this._sortedComputedProperties.length;a+=1)this._sortedComputedProperties[a].update(this._state,b);this.fire("state",{changed:b,previous:c,current:this._state});this._dependents.filter((a)=>
{let c={},d=!1;for(let e=0;e<a.props.length;e+=1){let f=a.props[e];f in b&&(c["$"+f]=this._state[f],d=!0)}if(d)return a.component._stage(c),!0}).forEach((a)=>{a.component.set({})});this.fire("update",{changed:b,previous:c,current:this._state})},_sortComputedProperties(){function a(f){let g=b[f];g&&(g.deps.forEach((b)=>{if(b===e)throw Error(`Cyclical dependency detected between ${b} <-> ${f}`);a(b)}),d[f]||(d[f]=!0,c.push(g)))}let b=this._computed,c=this._sortedComputedProperties=[],d=Object.create(null),
e;for(let b in this._computed)a(e=b)},compute(a,b,c){let d,e={deps:b,update:(e,f,g)=>{var h=b.map((a)=>{a in f&&(g=!0);return e[a]});g&&(h=c.apply(null,h),this._differs(h,d)&&(d=h,f[a]=!0,e[a]=d))}};this._computed[a]=e;this._sortComputedProperties();let f=r({},this._state),g={};e.update(f,g,!0);this._set(f,g)},fire:qd,get:rd,on:sd,set(a){let b=this._state,c=this._changed={},d=!1;for(let e in a){if(this._computed[e])throw Error(`'${e}' is a read-only computed property`);this._differs(a[e],b[e])&&(c[e]=
