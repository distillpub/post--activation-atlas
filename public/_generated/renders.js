	...
	function create_main_fragment$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(canvas0, file$3, 34, 4, 511);
				...
				addLoc(canvas1, file$3, 38, 4, 637);
				component.root._beforecreate.push(div_resize_handler);
