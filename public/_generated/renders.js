	...
	function create_main_fragment$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(canvas0, file$3, 37, 4, 599);
				...
				addLoc(canvas1, file$3, 41, 4, 725);
