...
y[b][l]=n}n[l]=y});this.set({layers:n,loading:!1})}))}}function Fd(b){x(this,b);this._state=q({fingerprint:Math.random()+Date.now(),root:"https://storage.googleapis.com/distill-2019-activation-atlas/build",id:"inceptionv1",labels:Tb.inception,layer:0,classFilter:0,filter:0,layout:0,config:null,layers:null,loading:!1},b.data);this._intro=!0;this._handlers.update=[ej];this._fragment={c:X,m:X,p:X,d:X};this.root._oncreate.push(()=>{this.fire("update",{changed:ia({},this._state),current:this._state})});
b.target&&(this._fragment.c(),this._mount(b.target,b.anchor),G(this))}function Gd(){for(var b=0,a=arguments.length,c={},d;b<a;++b){if(!(d=arguments[b]+"")||d in c)throw Error("illegal type: "+d);c[d]=[]}return new Rc(c)}function Rc(b){this._=b}function gj(b,a){return b.trim().split(/^|\s+/).map(function(b){var c="",e=b.indexOf(".");0<=e&&(c=b.slice(e+1),b=b.slice(0,e));if(b&&!a.hasOwnProperty(b))throw Error("unknown type: "+b);return{type:b,name:c}})}function ff(b,a,c){for(var d=0,e=b.length;d<e;++d)if(b[d].name===
a){b[d]=hj;b=b.slice(0,d).concat(b.slice(d+1));break}null!=c&&b.push({name:a,value:c});return b}function Sc(b){var a=b+="",c=a.indexOf(":");0<=c&&"xmlns"!==(a=b.slice(0,c))&&(b=b.slice(c+1));return gf.hasOwnProperty(a)?{space:gf[a],local:b}:b}function ij(b){return function(){var a=this.ownerDocument,c=this.namespaceURI;return"http://www.w3.org/1999/xhtml"===c&&"http://www.w3.org/1999/xhtml"===a.documentElement.namespaceURI?a.createElement(b):a.createElementNS(c,b)}}function jj(b){return function(){return this.ownerDocument.createElementNS(b.space,
...
null);k.appendChild(Ua);ha&&ha.m(k,null)},p(a,c){a.color&&f(g,"fill",c.color);a.width&&f(n,"width",c.width);a.height&&f(n,"height",c.height);a.comparison&&r!==(r="https://storage.googleapis.com/distill-2019-activation-atlas/build/gradients/gradients/gradients--comparison="+c.comparison.id+"--tries=4--alpha=False--tile_size=10--whiten=true--steps=1024--icon_size=90--grid_size=10--layer=mixed5b--model=InceptionV1--sample_images=1000000--sample_type=random.jpg")&&ab(n,"xlink:href",r);a.comparison&&p!==
(p=c.comparison.label)&&f(n,"alt",p);a.comparison&&w!==(w=c.comparison.leftLabel)&&W(T,w);a.comparison&&q!==(q=c.comparison.rightLabel)&&W(L,q);a.color&&(f(K,"stroke",c.color),f(M,"stroke",c.color));a.width&&N!==(N="translate("+c.width/2+", 0)")&&f(y,"transform",N);a.color&&(f(R,"stroke",c.color),f(x,"stroke",c.color));(a.margin||a.height)&&O!==(O="translate("+(-c.margin.left+8)+","+c.height/2+")")&&f(S,"transform",O);a.margin&&ea!==(ea=-c.margin.top+4)&&f(aa,"y1",ea);a.height&&fd!==(fd=c.height+
8)&&f(aa,"y2",fd);a.margin&&ba!==(ba=-c.margin.top+4)&&f(ra,"y1",ba);a.height&&Da!==(Da=c.height+8)&&f(ra,"y2",Da);a.width&&Ea!==(Ea="translate("+c.width/2+", 0)")&&f(X,"transform",Ea);if(a.width||a.height){wa=da(11);for(var e=0;e<wa.length;e+=1){var h=sg(c,wa,e);Ba[e]?Ba[e].p(a,h):(Ba[e]=tg(b,h),Ba[e].c(),Ba[e].m(k,oa))}for(;e<Ba.length;e+=1)Ba[e].d(1);Ba.length=wa.length}if(a.width||a.height){sa=da(11);for(e=0;e<sa.length;e+=1)h=rg(c,sa,e),Y[e]?Y[e].p(a,h):(Y[e]=ug(b,h),Y[e].c(),Y[e].m(k,Ua));for(;e<
Y.length;e+=1)Y[e].d(1);Y.length=sa.length}c.comparison.annotation?ha?ha.p(a,c):(ha=vg(b,c),ha.c(),ha.m(k,null)):ha&&(ha.d(1),ha=null);a.margin&&ia!==(ia="translate("+c.margin.left+","+c.margin.top+")")&&f(k,"transform",ia);(a.outerWidth||a.outerHeight)&&mb!==(mb="0 0 "+c.outerWidth+" "+c.outerHeight)&&f(d,"viewBox",mb)},d(a){a&&z(c);U(Ba,a);U(Y,a);ha&&ha.d()}}}function tg(b,a){var c,d;return{c(){c=v("line");f(c,"x2",a.width);f(c,"transform",d="translate(0, "+a.height/10*a.tick+")");f(c,"stroke",
...
e.length;g+=1)e[g].d(1);e.length=d.length}},d(a){U(e,a);a&&z(c)}}}function wg(b,a){var c,d,e,h,g,k=a.annotation.desc,n,l,p,y,u,E,A,J,w;return{c(){c=v("g");d=v("line");g=v("text");n=m(k);y=v("g");u=v("circle");A=v("circle");f(d,"x1",e=(a.annotation.pos.y+.5)*a.cellWidth+a.cellWidth/2*a.Math.sqrt(2));f(d,"x2",h=a.width+5);f(d,"stroke","black");f(d,"stroke-opacity","0.4");f(g,"x",l=a.width+10);f(g,"alignment-baseline","middle");f(g,"class","svelte-1jr0ob8");f(c,"transform",p="translate(0, "+(a.annotation.pos.x+
.5)*a.cellWidth+")");f(u,"r",E=a.cellWidth/2*a.Math.sqrt(2));f(u,"fill","none");f(u,"stroke","white");f(u,"stroke-opacity","0.5");f(u,"stroke-width","5");f(A,"r",J=a.cellWidth/2*a.Math.sqrt(2));f(A,"fill","none");f(A,"stroke","black");f(A,"stroke-opacity","1");f(y,"transform",w="translate("+(a.annotation.pos.y+.5)*a.cellWidth+", "+(a.annotation.pos.x+.5)*a.cellWidth+")")},m(a,b){a.insertBefore(c,b);c.appendChild(d);c.appendChild(g);g.appendChild(n);a.insertBefore(y,b);y.appendChild(u);y.appendChild(A)},
p(a,b){(a.comparison||a.cellWidth||a.Math)&&e!==(e=(b.annotation.pos.y+.5)*b.cellWidth+b.cellWidth/2*b.Math.sqrt(2))&&f(d,"x1",e);a.width&&h!==(h=b.width+5)&&f(d,"x2",h);a.comparison&&k!==(k=b.annotation.desc)&&W(n,k);a.width&&l!==(l=b.width+10)&&f(g,"x",l);(a.comparison||a.cellWidth)&&p!==(p="translate(0, "+(b.annotation.pos.x+.5)*b.cellWidth+")")&&f(c,"transform",p);(a.cellWidth||a.Math)&&E!==(E=b.cellWidth/2*b.Math.sqrt(2))&&f(u,"r",E);(a.cellWidth||a.Math)&&J!==(J=b.cellWidth/2*b.Math.sqrt(2))&&
f(A,"r",J);(a.comparison||a.cellWidth)&&w!==(w="translate("+(b.annotation.pos.y+.5)*b.cellWidth+", "+(b.annotation.pos.x+.5)*b.cellWidth+")")&&f(y,"transform",w)},d(a){a&&(z(c),z(y))}}}function tb(b){x(this,b);this._state=q(q(q({Math},this.store._init(["classComparisons"])),{width:504,selected:0,margin:{top:60,right:80,bottom:5,left:80},color:"#9a9cad",currentClassComparisonIndex:0}),b.data);this.store._add(this,["classComparisons"]);this._recompute({width:1,margin:1,height:1,currentClassComparisonIndex:1,
$classComparisons:1},this._state);this._intro=!0;this._handlers.destroy=[oa];this._fragment=cm(this,this._state);b.target&&(this._fragment.c(),this._mount(b.target,b.anchor))}function xg(b,a,c){b=Object.create(b);b.row=a[c];b.i=c;return b}function yg(b,a,c){b=Object.create(b);b.c=a[c];return b}function dm(b,a){for(var c,d=a.classifications,e=[],h=0;h<d.length;h+=1)e[h]=zg(b,yg(a,d,h));return{c(){c=l("div");for(var b=0;b<e.length;b+=1)e[b].c();c.className="adversarial svelte-1vijrjb";t(c,"grid-template-columns",
"repeat("+a.classifications.length+", 1fr)")},m(a,b){a.insertBefore(c,b);for(a=0;a<e.length;a+=1)e[a].m(c,null)},p(a,h){if(a.classifications||a.left||a.right||a.aspectRatio){d=h.classifications;for(var g=0;g<d.length;g+=1){let f=yg(h,d,g);e[g]?e[g].p(a,f):(e[g]=zg(b,f),e[g].c(),e[g].m(c,null))}for(;g<e.length;g+=1)e[g].d(1);e.length=d.length}a.classifications&&t(c,"grid-template-columns","repeat("+h.classifications.length+", 1fr)")},d(a){a&&z(c);U(e,a)}}}function Ag(b,a){var c,d,e=a.i+1,h,g,f,n,r=
a.row[0],p,y,u,E=Bg(a.row[1]),A,J,w;return{c(){c=l("tr");d=l("td");h=m(e);g=m(".");f=m("\n            ");n=l("td");p=m(r);y=m("\n            ");u=l("td");A=m(E);J=m("%");d.className="svelte-1vijrjb";n.className="svelte-1vijrjb";u.className="svelte-1vijrjb";c.className=w=(a.row[0]===a.left?"left":"")+" "+(a.row[0]===a.right?"right":"")+" svelte-1vijrjb"},m(a,b){a.insertBefore(c,b);c.appendChild(d);d.appendChild(h);d.appendChild(g);c.appendChild(f);c.appendChild(n);n.appendChild(p);c.appendChild(y);
c.appendChild(u);u.appendChild(A);u.appendChild(J)},p(a,b){a.classifications&&r!==(r=b.row[0])&&W(p,r);a.classifications&&E!==(E=Bg(b.row[1]))&&W(A,E);(a.classifications||a.left||a.right)&&w!==(w=(b.row[0]===b.left?"left":"")+" "+(b.row[0]===b.right?"right":"")+" svelte-1vijrjb")&&(c.className=w)},d(a){a&&z(c)}}}function zg(b,a){for(var c,d,e,h,g,f,n,r=a.c.caption,p,y,u=new O({root:b.root,store:b.store,data:{style:"image-rendering: crisp-edges;image-rendering: pixelated;",src:a.c.image,alt:""+a.left+
" / "+a.right,aspectRatio:a.aspectRatio}}),E=a.c.rows,A=[],J=0;J<E.length;J+=1)A[J]=Ag(b,xg(a,E,J));return{c(){c=l("div");d=l("div");u._fragment.c();e=m("\n      ");h=l("div");g=l("table");for(var a=0;a<A.length;a+=1)A[a].c();f=m("\n      ");n=l("div");p=m(r);y=m("\n    ");d.className="image";g.className="svelte-1vijrjb";h.className="table";n.className="figcaption svelte-1vijrjb";c.className="class svelte-1vijrjb"},m(a,b){a.insertBefore(c,b);c.appendChild(d);u._mount(d,null);c.appendChild(e);c.appendChild(h);
h.appendChild(g);for(a=0;a<A.length;a+=1)A[a].m(g,null);c.appendChild(f);c.appendChild(n);n.appendChild(p);c.appendChild(y)},p(a,c){var d={};a.classifications&&(d.src=c.c.image);if(a.left||a.right)d.alt=""+c.left+" / "+c.right;a.aspectRatio&&(d.aspectRatio=c.aspectRatio);u._set(d);if(a.classifications||a.left||a.right){E=c.c.rows;for(d=0;d<E.length;d+=1){let e=xg(c,E,d);A[d]?A[d].p(a,e):(A[d]=Ag(b,e),A[d].c(),A[d].m(g,null))}for(;d<A.length;d+=1)A[d].d(1);A.length=E.length}a.classifications&&r!==
(r=c.c.caption)&&W(p,r)},d(a){a&&z(c);u.destroy();U(A,a)}}}function Zb(b){x(this,b);this._state=q({image:"",left:"",right:"",classifications:[],aspectRatio:1},b.data);this._intro=!0;this._fragment=dm(this,this._state);b.target&&(this._fragment.c(),this._mount(b.target,b.anchor),G(this))}function em(b,a){var c,d,e,h,g,f,n,r,p,y,u,E,A=new O({root:b.root,store:b.store,data:{src:"assets/images/render--x%3D0--y%3D0--tries%3D4--alpha%3DFalse--tile_size%3D20--whiten%3Dtrue--steps%3D1024--icon_size%3D80--grid_size%3D20--layout%3D50_0.05_cosine--class_filter%3DNone--filter%3D10000--layer%3Dmixed4c--model%3DInceptionV1--sample_images%3D1000000--sample_type%3Drandom.jpg",
...
webURL:"https://storage.googleapis.com/distill-2019-activation-atlas/build/process/web/web--grid_size=10--layout=50_0.05_cosine--class_filter=None--filter=30000--layer=mixed4c--model=InceptionV1--sample_images=1000000--sample_type=random.json",dataURL:"https://storage.googleapis.com/distill-2019-activation-atlas/build/process/layout_data/layout_data--layout=50_0.05_cosine--class_filter=None--filter=30000--layer=mixed4c--model=InceptionV1--sample_images=1000000--sample_type=random.json",renderURL:"https://storage.googleapis.com/distill-2019-activation-atlas/build/process/render/render--x=0--y=0--tries=4--alpha=False--tile_size=10--whiten=true--steps=2048--icon_size=80--grid_size=10--layout=50_0.05_cosine--class_filter=None--filter=30000--layer=mixed4c--model=InceptionV1--sample_images=1000000--sample_type=random.jpg",
