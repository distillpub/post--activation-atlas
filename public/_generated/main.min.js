(function () {
	...
	function create_main_fragment$3(component, ctx) {
		...
		return {
			c() {
				div = createElement("div");
				div.innerHTML = `<span class="svelte-19e83wz">Loading …</span>`;
	...
	assign(Loading.prototype, proto);
	...
	assign(LazyComponent.prototype, proto);
	...
	assign(Placeholder.prototype, proto);
	...
	assign(LazyImage.prototype, proto);
	...
	assign(NotebookLink.prototype, proto);
	...
	function create_main_fragment$9(component, ctx) {
		...
		return {
			c() {
				...
				setAttribute(path, "d", "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z");
				setAttribute(path_1, "d", "M0 0h24v24H0z");
				setAttribute(path_1, "fill", "none");
	...
	assign(Baseline_add_24px.prototype, proto);
	...
	function create_main_fragment$a(component, ctx) {
		...
		return {
			c() {
				...
				path = createSvgElement("path");
				path_1 = createSvgElement("path");
				setAttribute(path, "d", "M19 13H5v-2h14v2z");
				setAttribute(path_1, "d", "M0 0h24v24H0z");
				setAttribute(path_1, "fill", "none");
				setAttribute(svg, "xmlns", "http://www.w3.org/2000/svg");
				setAttribute(svg, "width", "24");
	...
	assign(Baseline_remove_24px.prototype, proto);
	...
	function create_main_fragment$b(component, ctx) {
		...
		return {
			c() {
				...
				path = createSvgElement("path");
				path_1 = createSvgElement("path");
				setAttribute(path, "d", "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z");
				setAttribute(path_1, "d", "M0 0h24v24H0z");
				setAttribute(path_1, "fill", "none");
				setAttribute(svg, "xmlns", "http://www.w3.org/2000/svg");
				setAttribute(svg, "width", "24");
	...
	assign(Baseline_home_24px.prototype, proto);
	...
	assign(AtlasReticle.prototype, proto);
	...
	assign(AppMiniMap.prototype, proto);
	...
	assign(AppLayerChooser.prototype, proto);
	...
	assign(AppClassFilter.prototype, proto);
	...
	function create_main_fragment$l(component, ctx) {
	  ...
	  ;
		...
		component.root._beforecreate.push(() => {
			d3zoom._bind({ scale: 1, translateX: 1, translateY: 1, mouseOver: 1, mouseGlobalPosition: 1, extent: 1 }, d3zoom.get());
		});
	...
	function create_main_fragment$n(component, ctx) {
		var div25, div1, h20, text1, div0, appclassfilter_updating = {}, text2, div3, h21, text4, div2, applayerchooser_updating = {}, text5, div8, div7, atlas_updating = {}, text6, div6, div4, appminimap_updating = {}, text7, div5, text8, text9, text10, div24, h22, text12, div23, div13, div9, text13, raw0_before, text14, div10, text15, raw1_value = format_1$1(ctx.gcx), raw1_before, text16, div11, text17, raw2_value = format_1$1(ctx.gcy), raw2_before, text18, div12, text19, raw3_value = format_1$1(ctx.scale), raw3_before, text20, div14, h30, text22, label0, input0, text23, text24, div17, h31, text26, label1, input1, text27, text28, label2, input2, text29, text30, label3, input3, text31, text32, label4, input4, text33, text34, label5, input5, text35, text36, label6, input6, text37, text38, div16, div15, text39, raw4_before, text40, input7, text41, div20, h32, text43, div18, text44, raw5_before, text45, input8, text46, br, text47, div19, text48, raw6_before, text49, input9, text50, div22, h33, text52, div21, text53, raw7_before, text54, input10, text55, label7, input11, text56, text57, label8, input12, text58;
		...
		component.root._beforecreate.push(() => {
			atlas._bind({ density: 1, iconCrop: 1, classHeatmapMultiplier: 1, classHeatmapPositive: 1, autoGridSizeMultiplier: 1, gridSize: 1, showLabels: 1, scale: 1, aspectRatio: 1, gcx: 1, gcy: 1, extent: 1 }, atlas.get());
		});
		...
		return {
			c() {
				...
				input7.max = 1.4;
				input7.step = 0.01;
				setStyle(div16, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				div17.className = "grid-size";
				...
				setStyle(div22, "display", (ctx.classHeatmap > -1 ? 'block' : 'none'));
				setAttribute(div23, "slot", "body");
				div23.className = "options-body svelte-1rc1tnm";
				div24.className = "options svelte-1rc1tnm";
				setStyle(div24, "display", (ctx.showOptions ? 'block' : 'none'));
				div25.className = "container svelte-1rc1tnm";
			},
			...
			m(target, anchor) {
				...
				append(panel2._slotted.body, div23);
				append(div23, div13);
				append(div13, div9);
				append(div9, text13);
				append(div9, raw0_before);
				raw0_before.insertAdjacentHTML("afterend", ctx.extent);
				append(div13, text14);
				append(div13, div10);
				append(div10, text15);
				...
				append(label6, text37);
				append(div17, text38);
				append(div17, div16);
				append(div16, div15);
				append(div15, text39);
				append(div15, raw4_before);
				...
				append(label8, text58);
				panel2._mount(div24, null);
			},
	...
	assign(Overview.prototype, proto);
	...
	assign(ModelOverview.prototype, proto);
	...
	assign(GridDetail.prototype, proto);
	...
	assign(ClassAtlas.prototype, proto);
	...
	assign(ClassSubset.prototype, proto);
	...
	assign(ClassFilterComparison.prototype, proto);
	...
	assign(ClassComparison.prototype, proto);
	...
	assign(ClassGradient.prototype, proto);
	...
	assign(Adversarial.prototype, proto);
	...
	assign(Samples.prototype, proto);

	/* src/diagrams/ClassGrids.html generated by Svelte v2.15.3 */

	function create_main_fragment$y(component, ctx) {
		var div9, div2, div0, text0, div1, text3, div5, div3, text4, div4, text7, div8, div6, text8, div7;
		...
		return {
			c() {
				...
				text0 = createText("\n      ");
				div1 = createElement("div");
				div1.innerHTML = `<b>32 x 32</b> When the grid is too small, the feature visualizations are too small to see.`;
				text3 = createText("\n  ");
				div5 = createElement("div");
				div3 = createElement("div");
				lazyimage1._fragment.c();
				text4 = createText("\n      ");
				div4 = createElement("div");
				div4.innerHTML = `<b>8 x 8</b> When just right, the activation atlas shows all the concepts with feature visualizations that are big enough to see.`;
				text7 = createText("\n  ");
				div8 = createElement("div");
				div6 = createElement("div");
				lazyimage2._fragment.c();
				text8 = createText("\n      ");
				div7 = createElement("div");
				div7.innerHTML = `<b>2 x 2</b> When the grid is too big, concepts are lost in the averages. One sees less diversity within related concepts.`;
				div0.className = "atlas";
	...
	assign(ClassGrids.prototype, proto);
	...
	assign(ActivationGrid.prototype, proto);
	...
	assign(Process.prototype, proto);
	...
	assign(OneLayer.prototype, proto);
	...
	assign(LayerAnnotation.prototype, proto);
	...
	assign(ClippedIcon.prototype, proto);
	...
	assign(SetOfIcons.prototype, proto);
	...
	assign(ShowAPath.prototype, proto);
	...
	assign(VerticalLayerStatic.prototype, proto);
	...
	assign(Focus1Static.prototype, proto);
	...
	assign(Focus2Static.prototype, proto);
	...
	assign(Focus3Static.prototype, proto);
	...
	assign(Focus3TableStatic.prototype, proto);
