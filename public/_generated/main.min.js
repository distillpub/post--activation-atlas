...
m=k("div");H._fragment.c();l=h("\n    ");p=k("span");x=h(t);u=h("\n  ");b._bindingGroups[0].push(f);f.addEventListener("change",c,void 0);e(f,"type","radio");f.__value=n=a.layer;f.value=f.__value;f.className="svelte-hzvbih";w(m,"width","50px");w(m,"position","relative");p.className="svelte-hzvbih";d.className=y="layer "+(a.layerName==a.layer?"selected":"")+" svelte-hzvbih"},m(b,c){b.insertBefore(d,c);d.appendChild(f);f.checked=f.__value===a.layerName;d.appendChild(g);d.appendChild(m);H._mount(m,null);
d.appendChild(l);d.appendChild(p);p.appendChild(x);d.appendChild(u)},p(a,b){a.layerName&&(f.checked=f.__value===b.layerName);a.layers&&n!==(n=b.layer)&&(f.__value=n);f.value=f.__value;var c={};a.layers&&(c.layerName=b.layer);a.classHeatmap&&(c.classHeatmap=b.classHeatmap);H._set(c);a.layers&&t!==(t=b.layer)&&da(x,t);(a.layerName||a.layers)&&y!==(y="layer "+(b.layerName==b.layer?"selected":"")+" svelte-hzvbih")&&(d.className=y)},d(a){a&&D(d);b._bindingGroups[0].splice(b._bindingGroups[0].indexOf(f),
...
a,c){b=Object.create(b);b.l=a[c];return b}function Gg(b,a){for(var c,d=a.labels,f=[],e=0;e<d.length;e+=1)f[e]=Sd(b,Rd(a,d,e));return{c(){c=k("div");for(var a=0;a<f.length;a+=1)f[a].c();c.className="chooser svelte-h2ed57"},m(a,b){a.insertBefore(c,b);for(a=0;a<f.length;a+=1)f[a].m(c,null)},p(a,e){if(a.classHeatmap||a.labels){d=e.labels;for(var g=0;g<d.length;g+=1){let l=Rd(e,d,g);f[g]?f[g].p(a,l):(f[g]=Sd(b,l),f[g].c(),f[g].m(c,null))}for(;g<f.length;g+=1)f[g].d(1);f.length=d.length}},d(a){a&&D(c);
Z(f,a)}}}function Sd(b,a){function c(){b.set({classHeatmap:f.__value})}var d,f,n,g,m,l=a.l.label,p,t,x,u;return{c(){d=k("label");f=k("input");g=h("\n      ");m=k("span");p=h(l);x=h("\n    ");b._bindingGroups[0].push(f);f.addEventListener("change",c,void 0);e(f,"type","radio");f.__value=n=a.l.i;f.value=f.__value;f.className="svelte-h2ed57";m.title=t=a.l.i;d.className=u=(a.classHeatmap===a.l.i?"selected":"")+" svelte-h2ed57"},m(b,c){b.insertBefore(d,c);d.appendChild(f);f.checked=f.__value===a.classHeatmap;
d.appendChild(g);d.appendChild(m);m.appendChild(p);d.appendChild(x)},p(a,b){a.classHeatmap&&(f.checked=f.__value===b.classHeatmap);a.labels&&n!==(n=b.l.i)&&(f.__value=n);f.value=f.__value;a.labels&&l!==(l=b.l.label)&&da(p,l);a.labels&&t!==(t=b.l.i)&&(m.title=t);(a.classHeatmap||a.labels)&&u!==(u=(b.classHeatmap===b.l.i?"selected":"")+" svelte-h2ed57")&&(d.className=u)},d(a){a&&D(d);b._bindingGroups[0].splice(b._bindingGroups[0].indexOf(f),1);f.removeEventListener("change",c,void 0)}}}function Vc(b){F(this,
...
new T({target:document.querySelector("#focus-2"),store:C,data:{aspectRatio:2,component:hf}});new T({target:document.querySelector("#focus-3"),store:C,data:{aspectRatio:2,component:jf}});new T({target:document.querySelector("#focus-3-table"),store:C,data:{aspectRatio:1,component:kf}});new ob({target:document.querySelector("#focus-playground"),store:C,data:{classHeatmap:235}});new ge({target:document.querySelector("#class-subset"),store:C});new zc({target:document.querySelector("#class-comparison-1"),
store:C,data:{showControls:!1,classComparisonIndex:6}});new zc({target:document.querySelector("#class-comparison-2"),store:C,data:{showControls:!1,classComparisonIndex:0}});new Cb({target:document.querySelector("#class-gradient-snorkel"),store:C,data:{currentClassComparisonIndex:0}});new Cb({target:document.querySelector("#class-gradient-frying-pan"),store:C,data:{currentClassComparisonIndex:2}});new Cb({target:document.querySelector("#class-gradient-shark"),store:C,data:{currentClassComparisonIndex:8}});
