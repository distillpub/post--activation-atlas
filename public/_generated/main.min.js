...
ub=l("div");Nb=m("y: ");Ib=m(wb);Rb=m("\n                  ");yb=l("div");Tb=m("scale: ");Lb=m(zb);Ub=m("\n          ");Bb=l("div");ec=l("button");Gc._fragment.c();f(v,"slot","head");f(F,"slot","body");C.className="filter svelte-csxh56";t(C,"display",a.showClassFilter?"block":"none");f(N,"slot","head");f(z,"slot","body");M.className="stack svelte-csxh56";t(M,"display",a.showLayerChooser?"block":"none");H.className="panels svelte-csxh56";B.className="sidebar svelte-csxh56";kb.className="map-container svelte-csxh56";
t(kb,"width","100px");t(kb,"height","100px");t(kb,"position","absolute");cc.className="map svelte-csxh56";x.className="buttons svelte-csxh56";Z.className="nav svelte-csxh56";ra.addEventListener("change",c,void 0);f(ra,"type","checkbox");t(O,"white-space","nowrap");t(O,"text-overflow","ellipsis");t(O,"overflow","hidden");O.className="svelte-csxh56";X.addEventListener("change",d,void 0);f(X,"type","checkbox");Ea.className="svelte-csxh56";wa.addEventListener("change",e,void 0);f(wa,"type","checkbox");
mb.className="svelte-csxh56";U.className="essential";gd.className="svelte-csxh56";b._bindingGroups[0].push(fa);fa.addEventListener("change",h,void 0);f(fa,"type","radio");fa.__value=0;fa.value=fa.__value;Ja.className="svelte-csxh56";b._bindingGroups[0].push(Ca);Ca.addEventListener("change",g,void 0);f(Ca,"type","radio");Ca.__value=1;Ca.value=Ca.__value;Xb.className="svelte-csxh56";b._bindingGroups[0].push(za);za.addEventListener("change",k,void 0);f(za,"type","radio");za.__value=2;za.value=za.__value;
ea.className="svelte-csxh56";b._bindingGroups[0].push(Qa);Qa.addEventListener("change",n,void 0);f(Qa,"type","radio");Qa.__value=3;Qa.value=Qa.__value;oa.className="svelte-csxh56";b._bindingGroups[0].push(Ga);Ga.addEventListener("change",r,void 0);f(Ga,"type","radio");Ga.__value=4;Ga.value=Ga.__value;ya.className="svelte-csxh56";b._bindingGroups[0].push(Ha);Ha.addEventListener("change",p,void 0);f(Ha,"type","radio");Ha.__value=-1;Ha.value=Ha.__value;pa.className="svelte-csxh56";Ra.addEventListener("change",
y,void 0);Ra.addEventListener("input",y,void 0);f(Ra,"type","range");Ra.min=.5;Ra.max=1.4;Ra.step=.01;t(fb,"display","none");ca.className="section svelte-csxh56";ob.className="svelte-csxh56";Ia.addEventListener("change",u,void 0);Ia.addEventListener("input",u,void 0);f(Ia,"type","range");Ia.min=.2;Ia.max=8;Ia.step=.01;qb.className="section svelte-csxh56";Ma.className="svelte-csxh56";b._bindingGroups[1].push(db);db.addEventListener("change",E,void 0);f(db,"type","radio");db.__value=1;db.value=db.__value;
pc.className="svelte-csxh56";b._bindingGroups[1].push(eb);eb.addEventListener("change",A,void 0);f(eb,"type","radio");eb.__value=-1;eb.value=eb.__value;na.className="svelte-csxh56";lb.addEventListener("change",J,void 0);lb.addEventListener("input",J,void 0);f(lb,"type","range");lb.min="0.5";lb.max="2";lb.step="0.1";Fa.className="section svelte-csxh56";t(Fa,"display",-1<a.classHeatmap?"block":"none");Za.className="svelte-csxh56";Gb.className="section svelte-csxh56";ha.className="grid-size";Y.className=
"expand svelte-csxh56";P.className="options svelte-csxh56";ec.addEventListener("click",w,void 0);ec.className="svelte-csxh56";Bb.className="expand-toggle svelte-csxh56";ka.className=Eb="controls "+(a.showOptions?"open":"closed")+" svelte-csxh56 svelte-ref-controls";V.className="atlas svelte-csxh56";gb.className="main svelte-csxh56";T.className="container svelte-csxh56"},m(c,d){Gc._slotted.default.appendChild(T);T.appendChild(B);ib&&ib.m(B,null);B.appendChild(I);B.appendChild(H);H.appendChild(C);lc._slotted.head.appendChild(v);
...
null);k.appendChild(Ua);ha&&ha.m(k,null)},p(a,c){a.color&&f(g,"fill",c.color);a.width&&f(n,"width",c.width);a.height&&f(n,"height",c.height);a.comparison&&r!==(r="https://storage.googleapis.com/activation-atlas/build/gradients/gradients/gradients--comparison="+c.comparison.id+"--tries=4--alpha=False--tile_size=10--whiten=true--steps=1024--icon_size=90--grid_size=10--layer=mixed5b--model=InceptionV1--sample_images=1000000--sample_type=random.jpg")&&ab(n,"xlink:href",r);a.comparison&&p!==(p=c.comparison.label)&&
...
webURL:"https://storage.googleapis.com/activation-atlas/build/process/web/web--grid_size=10--layout=50_0.05_cosine--class_filter=None--filter=30000--layer=mixed4c--model=InceptionV1--sample_images=1000000--sample_type=random.json",dataURL:"https://storage.googleapis.com/activation-atlas/build/process/layout_data/layout_data--layout=50_0.05_cosine--class_filter=None--filter=30000--layer=mixed4c--model=InceptionV1--sample_images=1000000--sample_type=random.json",renderURL:"https://storage.googleapis.com/activation-atlas/build/process/render/render--x=0--y=0--tries=4--alpha=False--tile_size=10--whiten=true--steps=2048--icon_size=80--grid_size=10--layout=50_0.05_cosine--class_filter=None--filter=30000--layer=mixed4c--model=InceptionV1--sample_images=1000000--sample_type=random.jpg",
