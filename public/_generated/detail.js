	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				input6.max = 10;
				input6.step = 0.1;
				addLoc(input6, file$g, 90, 10, 2934);
				addLoc(br0, file$g, 91, 10, 3022);
				h43.className = "svelte-z55voj";
				addLoc(h43, file$g, 92, 10, 3037);
				...
				input7.max = 0.5;
				input7.step = 0.01;
				addLoc(input7, file$g, 93, 10, 3078);
				addLoc(div15, file$g, 88, 8, 2867);
				h44.className = "svelte-z55voj";
				addLoc(h44, file$g, 96, 10, 3244);
				...
				input8.max = "2";
				input8.step = "0.1";
				addLoc(input8, file$g, 97, 10, 3312);
				addLoc(br1, file$g, 98, 10, 3400);
				h45.className = "svelte-z55voj";
				addLoc(h45, file$g, 99, 10, 3415);
				addLoc(br2, file$g, 100, 10, 3465);
				...
				addLoc(input9, file$g, 101, 17, 3487);
				addLoc(label6, file$g, 101, 10, 3480);
				addLoc(br3, file$g, 102, 10, 3585);
				...
				addLoc(input10, file$g, 103, 17, 3607);
				addLoc(label7, file$g, 103, 10, 3600);
				setStyle(div16, "display", (ctx.classHeatmap > -1 ? 'block' : 'none'));
				addLoc(div16, file$g, 95, 8, 3172);
