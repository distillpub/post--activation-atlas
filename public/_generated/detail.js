(function () {
	...
	function create_main_fragment$h(component, ctx) {
		var div24, div1, h20, text1, div0, appclassfilter_updating = {}, text2, div3, h21, text4, div2, applayerchooser_updating = {}, text5, div8, div7, atlas_updating = {}, text6, div6, div4, appminimap_updating = {}, text7, div5, text8, text9, text10, div23, h22, text12, div22, div12, div9, text13, raw0_value = format_1(ctx.gcx), raw0_before, text14, div10, text15, raw1_value = format_1(ctx.gcy), raw1_before, text16, div11, text17, raw2_value = format_1(ctx.scale), raw2_before, text18, label0, input0, text19, text20, div13, h30, text22, label1, input1, text23, text24, div16, h31, text26, label2, input2, text27, text28, label3, input3, text29, text30, label4, input4, text31, text32, label5, input5, text33, text34, label6, input6, text35, text36, label7, input7, text37, text38, div15, div14, text39, raw3_before, text40, input8, text41, div19, h32, text43, div17, text44, raw4_before, text45, input9, text46, br, text47, div18, text48, raw5_before, text49, input10, text50, div21, h33, text52, div20, text53, raw6_before, text54, input11, text55, label8, input12, text56, text57, label9, input13, text58;
		...
		return {
			c: function create() {
				...
				addLoc(div4, file$g, 49, 10, 1279);
				div5.className = "buttons svelte-1rc1tnm";
				addLoc(div5, file$g, 59, 10, 1609);
				div6.className = "svelte-1rc1tnm svelte-ref-controls";
				addLoc(div6, file$g, 48, 8, 1250);
				...
				input8.max = 1.4;
				input8.step = 0.01;
				addLoc(input8, file$g, 93, 12, 3337);
				setStyle(div15, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div15, file$g, 91, 10, 3196);
				div16.className = "grid-size";
				addLoc(div16, file$g, 83, 8, 2649);
				addLoc(h32, file$g, 97, 10, 3480);
				addLoc(div17, file$g, 98, 10, 3505);
				...
				input9.max = 8;
				input9.step = 0.01;
				addLoc(input9, file$g, 99, 10, 3551);
				addLoc(br, file$g, 100, 10, 3631);
				addLoc(div18, file$g, 101, 10, 3646);
				...
				input10.max = 0.5;
				input10.step = 0.01;
				addLoc(input10, file$g, 102, 10, 3690);
				addLoc(div19, file$g, 96, 8, 3464);
				addLoc(h33, file$g, 105, 10, 3856);
				addLoc(div20, file$g, 106, 10, 3888);
				...
				input11.max = "2";
				input11.step = "0.1";
				addLoc(input11, file$g, 107, 10, 3951);
				...
				addLoc(input12, file$g, 108, 17, 4046);
				label8.className = "svelte-1rc1tnm";
				addLoc(label8, file$g, 108, 10, 4039);
