(function () {
	...
	function create_main_fragment$5(component, ctx) {
		...
		var if_block = (ctx.scale) && create_if_block(component, ctx);
	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div4, file$g, 47, 10, 1230);
				div5.className = "buttons svelte-1rc1tnm";
				addLoc(div5, file$g, 60, 10, 1635);
				div6.className = "svelte-1rc1tnm svelte-ref-controls";
				addLoc(div6, file$g, 46, 8, 1201);
				...
				input7.max = 1.4;
				input7.step = 0.01;
				addLoc(input7, file$g, 93, 12, 3276);
				setStyle(div15, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div15, file$g, 91, 10, 3135);
				div16.className = "grid-size";
				addLoc(div16, file$g, 83, 8, 2588);
				addLoc(h32, file$g, 97, 10, 3419);
				addLoc(div17, file$g, 98, 10, 3444);
				...
				input8.max = 8;
				input8.step = 0.01;
				addLoc(input8, file$g, 99, 10, 3490);
				addLoc(br, file$g, 100, 10, 3570);
				addLoc(div18, file$g, 101, 10, 3585);
				...
				input9.max = 0.5;
				input9.step = 0.01;
				addLoc(input9, file$g, 102, 10, 3629);
				addLoc(div19, file$g, 96, 8, 3403);
				addLoc(h33, file$g, 105, 10, 3795);
				addLoc(div20, file$g, 106, 10, 3827);
				...
				input10.max = "2";
				input10.step = "0.1";
				addLoc(input10, file$g, 107, 10, 3890);
				...
				addLoc(input11, file$g, 108, 17, 3985);
				label7.className = "svelte-1rc1tnm";
				addLoc(label7, file$g, 108, 10, 3978);
