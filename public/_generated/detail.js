	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(input0, file$g, 67, 19, 2077);
				addLoc(label0, file$g, 67, 12, 2070);
				addLoc(br0, file$g, 68, 12, 2157);
				addListener(input1, "change", input1_change_handler);
				setAttribute(input1, "type", "checkbox");
				addLoc(input1, file$g, 69, 19, 2181);
				addLoc(label1, file$g, 69, 12, 2174);
				addLoc(div7, file$g, 66, 10, 2052);
				...
				addLoc(input9, file$g, 97, 17, 3399);
				label9.className = "svelte-10yshsn";
				addLoc(label9, file$g, 97, 10, 3392);
				addLoc(div17, file$g, 99, 12, 3543);
				...
				input10.max = 1.4;
				input10.step = 0.01;
				addLoc(input10, file$g, 100, 12, 3613);
				setStyle(div18, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div18, file$g, 98, 10, 3472);
				div19.className = "grid-size";
				addLoc(div19, file$g, 90, 8, 2925);
				addLoc(h32, file$g, 104, 10, 3756);
				addLoc(div20, file$g, 105, 10, 3781);
				...
				input11.max = 8;
				input11.step = 0.01;
				addLoc(input11, file$g, 106, 10, 3827);
				addLoc(br1, file$g, 107, 10, 3907);
				addLoc(div21, file$g, 108, 10, 3922);
				...
				input12.max = 0.5;
				input12.step = 0.01;
				addLoc(input12, file$g, 109, 10, 3966);
				addLoc(div22, file$g, 103, 8, 3740);
				addLoc(h33, file$g, 112, 10, 4132);
				addLoc(div23, file$g, 113, 10, 4164);
				...
				input13.max = "2";
				input13.step = "0.1";
				addLoc(input13, file$g, 114, 10, 4227);
				...
				addLoc(input14, file$g, 115, 17, 4322);
				label10.className = "svelte-10yshsn";
				addLoc(label10, file$g, 115, 10, 4315);
