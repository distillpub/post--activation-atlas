	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				input6.max = 10;
				input6.step = 0.1;
				addLoc(input6, file$g, 93, 10, 3131);
				addLoc(br, file$g, 94, 10, 3219);
				addLoc(div16, file$g, 95, 10, 3234);
				...
				input7.max = 0.5;
				input7.step = 0.01;
				addLoc(input7, file$g, 96, 10, 3278);
				addLoc(div17, file$g, 90, 8, 3036);
				addLoc(h33, file$g, 99, 10, 3444);
				addLoc(div18, file$g, 100, 10, 3476);
				...
				input8.max = "2";
				input8.step = "0.1";
				addLoc(input8, file$g, 101, 10, 3539);
				...
				addLoc(input9, file$g, 102, 17, 3634);
				label6.className = "svelte-1rc1tnm";
				addLoc(label6, file$g, 102, 10, 3627);
