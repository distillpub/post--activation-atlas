(function () {
	...
	const file$7 = "src/library/D3Zoom.html";
	...
	const file$8 = "src/library/Radar.html";
	...
	function create_main_fragment$8(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(d_figure, file$8, 6, 0, 173);
			},
	...
	const file$a = "src/AtlasReticle.html";
	...
	const file$c = "src/components/AppMiniMap.html";
	...
	const file$d = "src/AtlasThumbnail.html";
	...
	function create_main_fragment$e(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(canvas, file$d, 2, 2, 54);
				component.root._beforecreate.push(div_resize_handler);
				setStyle(div, "height", "" + ctx.height + "px");
				addLoc(div, file$d, 1, 0, 1);
			},
	...
	const file$e = "src/components/AppLayerChooser.html";
	...
	const file$f = "src/components/AppClassFilter.html";
	...
	const file$g = "src/library/App/Panel.html";
	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div0, file$g, 1, 2, 21);
				div1.className = "body svelte-l56anp";
				addLoc(div1, file$g, 4, 2, 81);
	...
	function create_main_fragment$i(component, ctx) {
		...
		return {
			c: function create() {
				...
				input6.max = 8;
				input6.step = 0.01;
				addLoc(input6, file$h, 92, 10, 3090);
				addLoc(br, file$h, 93, 10, 3170);
				addLoc(div16, file$h, 94, 10, 3185);
				...
				input7.max = 0.5;
				input7.step = 0.01;
				addLoc(input7, file$h, 95, 10, 3229);
				addLoc(div17, file$h, 89, 8, 3003);
				addLoc(h33, file$h, 98, 10, 3395);
				addLoc(div18, file$h, 99, 10, 3427);
				...
				input8.max = "2";
				input8.step = "0.1";
				addLoc(input8, file$h, 100, 10, 3490);
				...
				addLoc(input9, file$h, 101, 17, 3585);
				label6.className = "svelte-1rc1tnm";
				addLoc(label6, file$h, 101, 10, 3578);
