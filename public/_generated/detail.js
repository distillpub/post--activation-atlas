(function () {
	...
	function left({clientWidth, extent}) {
		return Math.min(clientWidth, Math.max(0, extent[0][0] * clientWidth));
	}
	...
	function top({clientHeight, extent}) {
		return Math.min(clientHeight, Math.max(0, extent[1][0] * clientHeight));
	}
	...
	function create_main_fragment$7(component, ctx) {
		var div, img, img_src_value, img_alt_value, text, atlasreticle_updating = {};
		...
		return {
			c: function create() {
				...
				img.className = "svelte-10b429t";
				addLoc(img, file$7, 14, 4, 276);
			...
			m: function mount(target, anchor) {
				insert(target, div, anchor);
				append(placeholder._slotted.default, img);
	...
	function create_each_block(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div, file$9, 4, 4, 172);
				span.className = "svelte-hzvbih";
				addLoc(span, file$9, 7, 4, 291);
	...
	const file$c = "src/library/D3Zoom.html";
	...
	const file$d = "src/library/Radar.html";
	...
	function create_main_fragment$e(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(d_figure, file$d, 6, 0, 173);
			},
	...
	function create_main_fragment$f(component, ctx) {
		...
		var if_block1 = (ctx.showHoverIcon) && create_if_block$1(component, ctx);
	...
	function create_main_fragment$h(component, ctx) {
		var div27, div1, h20, text1, div0, appclassfilter_updating = {}, text2, div3, h21, text4, div2, applayerchooser_updating = {}, text5, div10, div9, atlas_updating = {}, text6, div8, div6, div4, appminimap_updating = {}, text7, div5, text8, text9, text10, div7, label0, input0, text11, text12, br0, text13, label1, input1, text14, text15, div26, h22, text17, div25, div15, div11, text18, raw0_before, text19, div12, text20, raw1_value = format_1(ctx.gcx), raw1_before, text21, div13, text22, raw2_value = format_1(ctx.gcy), raw2_before, text23, div14, text24, raw3_value = format_1(ctx.scale), raw3_before, text25, label2, input2, text26, text27, div16, h30, text29, label3, input3, text30, text31, div19, h31, text33, label4, input4, text34, text35, label5, input5, text36, text37, label6, input6, text38, text39, label7, input7, text40, text41, label8, input8, text42, text43, label9, input9, text44, text45, div18, div17, text46, raw4_before, text47, input10, text48, div22, h32, text50, div20, text51, raw5_before, text52, input11, text53, br1, text54, div21, text55, raw6_before, text56, input12, text57, div24, h33, text59, div23, text60, raw7_before, text61, input13, text62, label10, input14, text63, text64, label11, input15, text65;
		...
		component.root._beforecreate.push(() => {
			atlas._bind({ density: 1, iconCrop: 1, classHeatmapMultiplier: 1, classHeatmapPositive: 1, autoGridSizeMultiplier: 1, gridSize: 1, showLabels: 1, scale: 1, aspectRatio: 1, gcx: 1, gcy: 1, extent: 1, scrollWheel: 1 }, atlas.get());
		});
		...
		button0.on("click", function(event) {
			component.refs.atlas.home(1000);
		});
		...
		function input1_change_handler() {
			component.set({ showLabels: input1.checked });
		}
		...
		function input3_change_handler() {
			component.set({ showLabels: input3.checked });
		}
		...
		function input9_change_handler() {
			component.set({ gridSize: input9.__value });
		}

		function input10_change_input_handler() {
			component.set({ autoGridSizeMultiplier: toNumber(input10.value) });
		}

		function input11_change_input_handler() {
			component.set({ density: toNumber(input11.value) });
		}

		function input12_change_input_handler() {
			component.set({ iconCrop: toNumber(input12.value) });
		}
		...
		function input14_change_handler() {
			component.set({ classHeatmapPositive: input14.__value });
		}

		function input15_change_handler() {
			component.set({ classHeatmapPositive: input15.__value });
		}
		...
		return {
			c: function create() {
				...
				text11 = createText(" scroll to zoom");
				text12 = createText("\n            ");
				...
				addLoc(input9, file$g, 97, 17, 3390);
				label9.className = "svelte-10yshsn";
				addLoc(label9, file$g, 97, 10, 3383);
				addLoc(div17, file$g, 99, 12, 3534);
				...
				input10.max = 1.4;
				input10.step = 0.01;
				addLoc(input10, file$g, 100, 12, 3604);
				setStyle(div18, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div18, file$g, 98, 10, 3463);
				div19.className = "grid-size";
				addLoc(div19, file$g, 90, 8, 2916);
				addLoc(h32, file$g, 104, 10, 3747);
				addLoc(div20, file$g, 105, 10, 3772);
				...
				input11.max = 8;
				input11.step = 0.01;
				addLoc(input11, file$g, 106, 10, 3818);
				addLoc(br1, file$g, 107, 10, 3898);
				addLoc(div21, file$g, 108, 10, 3913);
				...
				input12.max = 0.5;
				input12.step = 0.01;
				addLoc(input12, file$g, 109, 10, 3957);
				addLoc(div22, file$g, 103, 8, 3731);
				addLoc(h33, file$g, 112, 10, 4123);
				addLoc(div23, file$g, 113, 10, 4155);
				...
				input13.max = "2";
				input13.step = "0.1";
				addLoc(input13, file$g, 114, 10, 4218);
				...
				addLoc(input14, file$g, 115, 17, 4313);
				label10.className = "svelte-10yshsn";
				addLoc(label10, file$g, 115, 10, 4306);
			...
			m: function mount(target, anchor) {
				...
				input1.checked = ctx.showLabels;

				append(label1, text14);
				component.refs.controls = div8;
				append(div27, text15);
				append(div27, div26);
				append(panel2._slotted.head, h22);
				append(panel2._slotted.default, text17);
				append(panel2._slotted.body, div25);
				append(div25, div15);
				append(div15, div11);
				append(div11, text18);
				append(div11, raw0_before);
				raw0_before.insertAdjacentHTML("afterend", ctx.homeScale);
				append(div15, text19);
				append(div15, div12);
				append(div12, text20);
				append(div12, raw1_before);
				...
				input3.checked = ctx.showLabels;

				append(label3, text30);
				append(div25, text31);
				append(div25, div19);
				append(div19, h31);
				append(div19, text33);
				...
				append(label8, text42);
				append(div19, text43);
				append(div19, label9);
				append(label9, input9);

				input9.checked = input9.__value === ctx.gridSize;

				append(label9, text44);
				append(div19, text45);
				append(div19, div18);
				append(div18, div17);
				append(div17, text46);
				append(div17, raw4_before);
				raw4_before.insertAdjacentHTML("afterend", ctx.autoGridSizeMultiplier);
				append(div18, text47);
				append(div18, input10);

				input10.value = ctx.autoGridSizeMultiplier;
				...
				append(div22, div20);
				append(div20, text51);
				append(div20, raw5_before);
				raw5_before.insertAdjacentHTML("afterend", ctx.density);
				append(div22, text52);
				append(div22, input11);

				input11.value = ctx.density;
				...
				append(div22, div21);
				append(div21, text55);
				append(div21, raw6_before);
				raw6_before.insertAdjacentHTML("afterend", ctx.iconCrop);
				append(div22, text56);
				append(div22, input12);

				input12.value = ctx.iconCrop;
				...
				append(div24, div23);
				append(div23, text60);
				append(div23, raw7_before);
				raw7_before.insertAdjacentHTML("afterend", ctx.classHeatmapMultiplier);
				append(div24, text61);
				append(div24, input13);
				...
				input14.checked = input14.__value === ctx.classHeatmapPositive;

				append(label10, text63);
				append(div24, text64);
				append(div24, label11);
				append(label11, input15);

				input15.checked = input15.__value === ctx.classHeatmapPositive;

				append(label11, text65);
				panel2._mount(div26, null);
			},
			...
			p: function update(changed, _ctx) {
	          ...
	          ;
	           ...
	           !== void 0;
				...
				if ((changed.gcx) && raw1_value !== (raw1_value = format_1(ctx.gcx))) {
					detachAfter(raw1_before);
					raw1_before.insertAdjacentHTML("afterend", raw1_value);
				}

				if ((changed.gcy) && raw2_value !== (raw2_value = format_1(ctx.gcy))) {
					detachAfter(raw2_before);
					raw2_before.insertAdjacentHTML("afterend", raw2_value);
				}

				if ((changed.scale) && raw3_value !== (raw3_value = format_1(ctx.scale))) {
				...
				if (changed.gridSize) input9.checked = input9.__value === ctx.gridSize;
				if (changed.autoGridSizeMultiplier) {
					detachAfter(raw4_before);
					raw4_before.insertAdjacentHTML("afterend", ctx.autoGridSizeMultiplier);
				}

				if (changed.autoGridSizeMultiplier) input10.value = ctx.autoGridSizeMultiplier;
				if (changed.gridSize) {
					setStyle(div18, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				}
				...
				if (changed.density) input11.value = ctx.density;
				if (changed.iconCrop) {
					detachAfter(raw6_before);
					raw6_before.insertAdjacentHTML("afterend", ctx.iconCrop);
				}

				if (changed.iconCrop) input12.value = ctx.iconCrop;
				...
				if (changed.classHeatmapPositive) input14.checked = input14.__value === ctx.classHeatmapPositive;
				if (changed.classHeatmapPositive) input15.checked = input15.__value === ctx.classHeatmapPositive;
				if (changed.classHeatmap) {
					setStyle(div24, "display", (ctx.classHeatmap > -1 ? 'block' : 'none'));
				}
			...
			d: function destroy$$1(detach) {
				...
				if (component.refs.controls === div8) component.refs.controls = null;
				...
				component._bindingGroups[0].splice(component._bindingGroups[0].indexOf(input9), 1);
				...
				removeListener(input11, "change", input11_change_input_handler);
				removeListener(input11, "input", input11_change_input_handler);
				removeListener(input12, "change", input12_change_input_handler);
				removeListener(input12, "input", input12_change_input_handler);
				removeListener(input13, "change", input13_change_input_handler);
				removeListener(input13, "input", input13_change_input_handler);
				component._bindingGroups[1].splice(component._bindingGroups[1].indexOf(input14), 1);
				removeListener(input14, "change", input14_change_handler);
				component._bindingGroups[1].splice(component._bindingGroups[1].indexOf(input15), 1);
	...
	function App(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["scroll"]), data$c()), options.data);
	...
	const file$h = "src/library/Tooltip.html";
	...
	const file$i = "src/components/AtlasTooltip.html";
	...
	function create_main_fragment$j(component, ctx) {
		...
		var if_block = (ctx.top_class_indices) && create_if_block$3(component, ctx);
	...
	function create_each_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(td0, file$i, 5, 8, 126);
				td1.className = "" + (ctx.i == 0 ? 'first': '') + " svelte-1b6k7p4";
				addLoc(td1, file$i, 6, 8, 212);
				setStyle(td2, "text-align", "right");
				td2.className = "svelte-1b6k7p4";
				addLoc(td2, file$i, 7, 8, 284);
				addLoc(tr, file$i, 4, 6, 113);
			},
