(function () {
	...
	const file$7 = "src/library/Radar.html";
	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(br1, file$g, 100, 10, 3458);
				addLoc(div19, file$g, 101, 10, 3473);
				addLoc(br2, file$g, 102, 10, 3515);
				...
				addLoc(input9, file$g, 103, 17, 3537);
				addLoc(label6, file$g, 103, 10, 3530);
				addLoc(br3, file$g, 104, 10, 3635);
