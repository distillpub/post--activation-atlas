	...
	function create_main_fragment$f(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(canvas0, file$e, 31, 4, 468);
				...
				addLoc(canvas1, file$e, 35, 4, 594);
				component.root._beforecreate.push(div_resize_handler);
	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				input8.max = 1.4;
				input8.step = 0.01;
				addLoc(input8, file$g, 84, 20, 3289);
				...
				addLoc(h31, file$g, 88, 18, 3483);
				addLoc(div11, file$g, 89, 18, 3516);
				...
				input9.max = 8;
				input9.step = 0.01;
				addLoc(input9, file$g, 90, 18, 3570);
				div12.className = "section svelte-1xmf6n";
				addLoc(div12, file$g, 87, 16, 3442);
				h32.className = "svelte-1xmf6n";
				addLoc(h32, file$g, 96, 18, 3949);
				addLoc(div13, file$g, 97, 18, 3989);
				...
				input10.max = "2";
				input10.step = "0.1";
				addLoc(input10, file$g, 98, 18, 4060);
				...
				addLoc(input11, file$g, 99, 25, 4163);
				label8.className = "svelte-1xmf6n";
				addLoc(label8, file$g, 99, 18, 4156);
