	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(input9, file$g, 97, 17, 3392);
				label9.className = "svelte-10yshsn";
				addLoc(label9, file$g, 97, 10, 3385);
				addLoc(div17, file$g, 99, 12, 3536);
				...
				input10.max = 1.4;
				input10.step = 0.01;
				addLoc(input10, file$g, 100, 12, 3606);
				setStyle(div18, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div18, file$g, 98, 10, 3465);
				div19.className = "grid-size";
				addLoc(div19, file$g, 90, 8, 2918);
				addLoc(h32, file$g, 104, 10, 3749);
				addLoc(div20, file$g, 105, 10, 3774);
				...
				input11.max = 8;
				input11.step = 0.01;
				addLoc(input11, file$g, 106, 10, 3820);
				addLoc(br1, file$g, 107, 10, 3900);
				addLoc(div21, file$g, 108, 10, 3915);
				...
				input12.max = 0.5;
				input12.step = 0.01;
				addLoc(input12, file$g, 109, 10, 3959);
				addLoc(div22, file$g, 103, 8, 3733);
				addLoc(h33, file$g, 112, 10, 4125);
				addLoc(div23, file$g, 113, 10, 4157);
				...
				input13.max = "2";
				input13.step = "0.1";
				addLoc(input13, file$g, 114, 10, 4220);
				...
				addLoc(input14, file$g, 115, 17, 4315);
				label10.className = "svelte-10yshsn";
				addLoc(label10, file$g, 115, 10, 4308);
