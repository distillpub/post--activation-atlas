	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				addLoc(div4, file$g, 50, 12, 1309);
				div5.className = "buttons svelte-10yshsn";
				addLoc(div5, file$g, 60, 12, 1659);
				div6.className = "nav svelte-10yshsn";
				addLoc(div6, file$g, 49, 10, 1279);
				addListener(input0, "change", input0_change_handler);
				setAttribute(input0, "type", "checkbox");
				addLoc(input0, file$g, 67, 19, 2065);
				addLoc(label0, file$g, 67, 12, 2058);
				addLoc(br0, file$g, 68, 12, 2147);
				addListener(input1, "change", input1_change_handler);
				setAttribute(input1, "type", "checkbox");
				addLoc(input1, file$g, 69, 19, 2171);
				addLoc(label1, file$g, 69, 12, 2164);
				addLoc(div7, file$g, 66, 10, 2040);
				div8.className = "svelte-10yshsn svelte-ref-controls";
				addLoc(div8, file$g, 48, 8, 1250);
				...
				addLoc(input9, file$g, 97, 17, 3384);
				label9.className = "svelte-10yshsn";
				addLoc(label9, file$g, 97, 10, 3377);
				addLoc(div17, file$g, 99, 12, 3528);
				...
				input10.max = 1.4;
				input10.step = 0.01;
				addLoc(input10, file$g, 100, 12, 3598);
				setStyle(div18, "display", (ctx.gridSize == -1 ? 'block': 'none'));
				addLoc(div18, file$g, 98, 10, 3457);
				div19.className = "grid-size";
				addLoc(div19, file$g, 90, 8, 2910);
				addLoc(h32, file$g, 104, 10, 3741);
				addLoc(div20, file$g, 105, 10, 3766);
				...
				input11.max = 8;
				input11.step = 0.01;
				addLoc(input11, file$g, 106, 10, 3812);
				addLoc(br1, file$g, 107, 10, 3892);
				addLoc(div21, file$g, 108, 10, 3907);
				...
				input12.max = 0.5;
				input12.step = 0.01;
				addLoc(input12, file$g, 109, 10, 3951);
				addLoc(div22, file$g, 103, 8, 3725);
				addLoc(h33, file$g, 112, 10, 4117);
				addLoc(div23, file$g, 113, 10, 4149);
				...
				input13.max = "2";
				input13.step = "0.1";
				addLoc(input13, file$g, 114, 10, 4212);
				...
				addLoc(input14, file$g, 115, 17, 4307);
				label10.className = "svelte-10yshsn";
				addLoc(label10, file$g, 115, 10, 4300);
