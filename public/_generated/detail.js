(function () {
	  ...
	  if (changed.layer || changed.classFilter || changed.id || changed.layout || changed.filter) {
	    ...
	    load$1(`${root}/${id}/${id}.json`, fingerprint).then(response => {
	      ...
	      if (classFilter !== null) {
	        ...
	        //gcs-back/class_filter_inceptionv1/web/web--grid_size=8--layout=5_0.1_cosine,10_0.1_cosine,15_0.1_cosine--class_filter=7--filter=None--layer=mixed4a--model=InceptionV1--sample_images=1000000--sample_type=random.json
	        //gcs-back/class_filter_inceptionv1/web/web--grid_size%3D16--layout%3D10_0.1_cosine--class_filter%3D1--filter%3DNone--layer%3Dmixed4a--model%3DInceptionV1--sample_images%3D1000000--sample_type%3Drandom.json
	        // console.log(config)
	...
	function create_main_fragment$h(component, ctx) {
		...
		return {
			c: function create() {
				...
				input8.max = 1.4;
				input8.step = 0.01;
				addLoc(input8, file$g, 89, 20, 3495);
				setStyle(div9, "display", (ctx.gridSize == -1 ? 'none': 'none'));
				addLoc(div9, file$g, 87, 18, 3339);
				div10.className = "section svelte-1xmf6n";
				addLoc(div10, file$g, 79, 16, 2730);
				h31.className = "svelte-1xmf6n";
				addLoc(h31, file$g, 93, 18, 3689);
				...
				input9.max = 8;
				input9.step = 0.01;
				addLoc(input9, file$g, 94, 18, 3746);
				div11.className = "section svelte-1xmf6n";
				addLoc(div11, file$g, 92, 16, 3648);
				h32.className = "svelte-1xmf6n";
				addLoc(h32, file$g, 100, 18, 4125);
				...
				addLoc(input10, file$g, 101, 25, 4172);
				label8.className = "svelte-1xmf6n";
				addLoc(label8, file$g, 101, 18, 4165);
				...
				addLoc(input11, file$g, 102, 25, 4285);
				label9.className = "svelte-1xmf6n";
				addLoc(label9, file$g, 102, 18, 4278);
				addLoc(div12, file$g, 103, 18, 4392);
	...
	function App(options) {
		...
		init(this, options);
		this.refs = {};
		this._state = assign(assign(this.store._init(["scroll"]), data$d()), options.data);
